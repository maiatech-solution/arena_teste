...
Route::middleware(['auth', 'gestor'])->prefix('bar')->name('bar.')->group(function () {
    ...
    Route::prefix('vendas')->name('vendas.')->group(function () {
        Route::get('/', [BarOrderController::class, 'indexVendas'])->name('index');
        // Mudamos de {order} para {sale} para bater com o Controller
        Route::post('/{sale}/cancelar', [BarOrderController::class, 'cancelarVenda'])->name('cancelar');
    });
