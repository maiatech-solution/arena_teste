    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('pagamentos')->name('payment.')->group(function () {
            ...
            Route::middleware(['role:admin,gestor,colaborador'])->group(function () {
                ...
                Route::get('/{reserva}/imprimir-cupom', [PaymentController::class, 'imprimirCupom'])->name('print');
            ...
            Route::middleware(['role:admin,gestor'])->group(function () {
                // Coloque aqui rotas como estorno de fechamento ou exclusão de logs se houver
            });
        });
