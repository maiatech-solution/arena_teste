...
Route::middleware(['auth', 'gestor'])->prefix('bar')->name('bar.')->group(function () {
    ...
    // 🏢 DADOS DA EMPRESA (URL ÚNICA PARA EVITAR CONFLITO)
    // No seu routes/web.php dentro do grupo do Bar
    Route::get('/configuracao-unidade/empresa', [BarCompanyController::class, 'edit'])->name('company.edit');
    Route::put('/configuracao-unidade/empresa', [BarCompanyController::class, 'update'])->name('company.update');
