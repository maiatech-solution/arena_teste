...
Route::middleware(['auth', 'gestor'])->prefix('bar')->name('bar.')->group(function () {
    ...
    // 🏢 DADOS DA EMPRESA (Trocando o prefixo para matar o cache)
    Route::prefix('ajustes')->name('company.')->group(function () {
        Route::get('/unidade', [BarCompanyController::class, 'edit'])->name('edit');
        Route::put('/unidade', [BarCompanyController::class, 'update'])->name('update');
    });
