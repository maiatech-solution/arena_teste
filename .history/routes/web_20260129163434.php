...
Route::middleware(['auth', 'gestor'])->prefix('bar')->name('bar.')->group(function () {
    ...
    Route::get('/ajustes/estabelecimento', [BarCompanyController::class, 'edit'])->name('company.edit');
    Route::put('/ajustes/estabelecimento', [BarCompanyController::class, 'update'])->name('company.update');
