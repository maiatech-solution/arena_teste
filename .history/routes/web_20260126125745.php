...
Route::middleware(['auth', 'gestor'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // 🔍 ROTA DE BUSCA PREDITIVA (Autocomplete do Dashboard)
        // Adicionada aqui para gerar a URL /admin/buscar-clientes
        Route::get('/buscar-clientes', [UserController::class, 'searchClients'])->name('buscar-clientes');
        ...
        Route::prefix('financeiro')->name('financeiro.')->group(function () {
            ...
            // 🚀 NOVA ROTA DE DÍVIDAS PENDENTES
