...
Route::middleware(['auth', 'gestor'])->group(function () {
    ...
    // O parâmetro da rota foi alterado para {id} no web.php, mas o nome do parâmetro no Controller foi corrigido.
    ...
    Route::post('/admin/config/fixed-reserva/{id}/status', [ConfigurationController::class, 'toggleFixedReservaStatus'])->name('admin.config.update_status');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // 🛑 AS ROTAS AJAX DE fixed-reserva e delete-config FORAM REMOVIDAS DAQUI E MOVIDAS ACIMA.
