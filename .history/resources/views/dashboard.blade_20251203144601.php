    ...
    <script>
        ...
        window.onload = function() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventSources: [
                    {
                        ...
                        eventDataTransform: function(eventData) {
                            // ✅ DEBUG: Adicionado para rastrear eventos recebidos
                            ...
                            // Se o status for 'paid', mas o backend removeu, ele nunca chega aqui.
                            // Se ele chega aqui, o front-end irá exibi-lo (e o eventDidMount irá desbotá-lo).
                            return eventData;
                        }
                    },
                    {
                ...
                // ✅ HOOK ATUALIZADO: Lógica para mostrar APENAS O NOME, aplicar PAGO e aplicar classes
