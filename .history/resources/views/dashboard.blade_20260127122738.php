<x-app-layout>
    ...
    <style>
        ...
        .autocomplete-container {
            ...
            /* Faz o WhatsApp descer suavemente */
            margin-bottom: 0;
        }
        ...
        .is-searching {
            margin-bottom: 210px;
            /* Empurra o campo de WhatsApp para baixo */
        }
    ...
    <div class="py-12">
     ...
     {{-- Modal de Agendamento Rápido (Com Empurrão Dinâmico para Autocomplete) --}}
        ...
        <div class="p-4 overflow-y-auto custom-scrollbar">
            <form id="quick-booking-form">
                ...
                <div class="space-y-4">
                    ...
                    {{-- 2. CAMPO WHATSAPP (Será empurrado para baixo pela div acima) --}}
                    <div>
                        ...
                        <p id="whatsapp-error-message" class="text-[10px] text-red-600 mt-1 hidden font-semibold">
                            ⚠️ Insira 11 dígitos.
                        </p>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="signal_value_quick" class="block text-xs font-bold text-gray-500 uppercase">Sinal (R$)</label>
                        ...
                        <div>
                            <label for="payment_method_quick" class="block text-xs font-bold text-gray-500 uppercase">Método</label>
                    ...
                    <div class="p-3 border border-indigo-100 rounded-lg bg-indigo-50/50 flex items-center">
                        ...
                        <label for="is-recurrent" class="ml-3 text-sm font-bold text-indigo-700 uppercase tracking-tighter">
                    ...
                    {{-- 5. OBSERVAÇÕES --}}
                    <div>
                        <label for="notes" class="block text-xs font-bold text-gray-500 uppercase">Observações</label>
