            ...
            <div @click.away="modalDetalhes = false"
                ...
                <div class="p-10 relative">
                    <div class="flex justify-between items-start mb-8">
                        <div>
                            <h3 class="text-white text-3xl font-black uppercase italic tracking-tighter">Resumo <span
                    ...
                    <div x-show="carregando" class="py-20 text-center"><span
                            class="animate-pulse text-orange-500 font-black uppercase text-xs tracking-[0.3em]">Carregando
                            Itens...</span></div>

                    <div x-show="!carregando" class="space-y-6">
                        <div class="bg-black/40 rounded-[2rem] p-6 border border-gray-800/50">
                            <label
                                class="text-[8px] font-black text-gray-600 uppercase tracking-widest block mb-4">Itens
                                da Transação</label>
