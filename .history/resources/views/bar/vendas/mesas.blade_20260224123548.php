                    ...
                    <tbody class="divide-y divide-gray-800/40">
                        @forelse($vendas as $venda)
                            ...
                            <tr class="hover:bg-white/[0.01] transition-colors group">
                                ...
                                <td class="p-8">
                                    <button @click="abrirDetalhes({{ $venda->id }})" class="flex items-center gap-2 px-4 py-2 bg-gray-950 border border-gray-800 rounded-xl text-[10px] font-black uppercase text-gray-400 hover:text-orange-400 hover:border-orange-500 transition-all">
                                        <span>🔍</span> Ver Itens
                                    </button>
                                </td>
            ...
            <div @click.away="modalDetalhes = false" class="bg-gray-900 border border-gray-800 w-full max-w-md rounded-[3rem] overflow-hidden shadow-2xl relative">
                ...
                <div class="p-10 relative">
                    <div class="flex justify-between items-start mb-8">
                        <div>
                            <h3 class="text-white text-3xl font-black uppercase italic tracking-tighter">Comanda <span class="text-orange-500">#</span><span x-text="venda.id"></span></h3>
                    ...
                    <div x-show="carregando" class="py-20 text-center"><span class="animate-pulse text-orange-500 font-black uppercase text-xs tracking-[0.3em]">Buscando Comanda...</span></div>
                            ...
                            <div class="space-y-4 max-h-60 overflow-y-auto no-scrollbar">
                                <template x-for="item in venda.itens">
                                    <div class="flex justify-between items-center border-b border-gray-800 pb-3 last:border-0">
                                        <div>
                                            <span class="text-orange-400 font-black text-xs" x-text="item.qtd + 'x '"></span>
        ...
        <div id="modalCancelamento" class="hidden fixed inset-0 z-[120] flex items-center justify-center bg-black/95 backdrop-blur-md p-4">
            <div class="bg-gray-900 border border-gray-800 w-full max-w-md rounded-[3rem] p-10 shadow-2xl relative overflow-hidden">
                ...
                <div class="text-center mb-8">
                    <div class="w-20 h-20 bg-orange-600/10 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-orange-600/20 shadow-xl">
                        <span class="text-4xl">🚫</span>
                    </div>
                    <h3 class="text-white text-2xl font-black uppercase italic tracking-tighter">Anular Comanda <span id="cancel_id_text" class="text-orange-500"></span></h3>
                ...
                <form id="formCancelarMesa" method="POST">
                    ...
                    <div class="space-y-6">
                        <textarea name="reason" required placeholder="Motivo do estorno..." class="w-full bg-black border border-gray-800 rounded-3xl p-5 text-white text-xs h-28 focus:border-orange-500 transition-all shadow-inner placeholder:text-gray-700"></textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-10">
                        ...
                        <button type="button" onclick="confirmarCancelamentoMesa()" class="py-5 bg-orange-600 hover:bg-orange-500 text-white font-black rounded-3xl uppercase text-[10px] tracking-widest shadow-xl shadow-orange-900/40 active:scale-95 transition-all">Confirmar</button>
                    </div>
                </form>
            </div>
        </div>
