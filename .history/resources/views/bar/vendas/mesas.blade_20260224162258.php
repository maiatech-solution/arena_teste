                            ...
                            <template x-if="parseFloat(venda.desconto) > 0">
                                <div class="space-y-2 bg-black/20 p-4 rounded-2xl mb-4">
                                    <div class="flex justify-between items-center text-[10px] font-black uppercase italic text-gray-500">
                                        ...
                                        <span x-text="'R$ ' + (parseFloat(venda.total_raw) + parseFloat(venda.desconto)).toLocaleString('pt-BR', {minimumFractionDigits: 2})"></span>
                                    </div>
                                    <div class="flex justify-between items-center text-[10px] font-black uppercase italic text-red-500">
                                        <span>Desconto Especial</span>
                                        <span x-text="'- R$ ' + parseFloat(venda.desconto).toLocaleString('pt-BR', {minimumFractionDigits: 2})"></span>
                                    </div>
                                </div>
                            </template>
