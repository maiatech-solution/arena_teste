<x-bar-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('bar.pos.index') }}" class="group bg-gray-900 p-8 rounded-3xl border border-gray-800 hover:border-orange-600/50 transition-all duration-300 shadow-2xl relative overflow-hidden">
