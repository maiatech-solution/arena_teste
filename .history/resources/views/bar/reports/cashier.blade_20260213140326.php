    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    ...
                    @forelse($sessoes as $sessao)
                        @php
                            ...
                            if($sessao->status == 'closed') {
                                // O confronto é: O que foi contado (closing) vs O que deveria ter (expected)
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            <div class="p-8 bg-gray-900/60 border border-gray-800 rounded-[2rem]">
                <h4 class="text-emerald-500 text-[10px] font-black uppercase tracking-widest mb-3 italic">Entenda o Cálculo</h4>
                <p class="text-[10px] text-gray-500 font-bold uppercase leading-relaxed">
                    O <span class="text-white">Total Esperado</span> é a soma do Fundo de Abertura + Vendas do Turno. A diferença nasce quando o valor contado fisicamente diverge desse número.
                </p>
            </div>
            <div class="p-8 bg-gray-900/60 border border-gray-800 rounded-[2rem]">
                <h4 class="text-orange-500 text-[10px] font-black uppercase tracking-widest mb-3 italic">Auditoria</h4>
                <p class="text-[10px] text-gray-500 font-bold uppercase leading-relaxed">
                    Vendas do Turno com valor <span class="text-orange-500">negativo</span> indicam que o caixa realizou mais sangrias/estornos do que vendas reais no período.
                </p>
            </div>
        </div>
