                    ...
                    <tbody class="divide-y divide-gray-800/50">
                        @forelse($movimentacoes as $mov)
                            <tr class="hover:bg-white/[0.02] transition-colors group">
                                ...
                                <td class="p-6">
                                    <div class="flex items-center gap-3">
                                        {{-- Em vez de ícone, mostramos o ID do produto com destaque --}}
                                        <div
                                            ...
                                            <span
                                                class="text-[8px] text-gray-600 font-black uppercase leading-none">ID</span>
                                            <span
                                                class="text-xs text-orange-500 font-mono font-black">{{ $mov->product->id }}</span>

                                            {{-- Mantemos apenas a bolinha vermelha se o estoque estiver crítico --}}
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if ($mov->product->stock_quantity <= 10)
                                            <span
                                                class="text-[8px] font-black text-red-500 uppercase px-1.5 py-0.5 bg-red-500/10 border border-red-500/20 rounded-md animate-pulse">
                                                Estoque Crítico: {{ $mov->product->stock_quantity }}
                                            </span>
                                        @endif
                                    </div>
