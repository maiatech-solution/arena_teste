    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-black/40 border-b border-gray-800">
                        ...
                        <th class="p-6 text-[10px] font-black text-gray-500 uppercase tracking-widest text-right">Fundo Abertura</th>
                        <th class="p-6 text-[10px] font-black text-gray-500 uppercase tracking-widest text-right">Vendas do Turno</th>
                        <th class="p-6 text-[10px] font-black text-gray-500 uppercase tracking-widest text-right">Total Esperado</th>
                        <th class="p-6 text-[10px] font-black text-white uppercase tracking-widest text-right italic">Fechamento Real</th>
                ...
                <tbody class="divide-y divide-gray-800/50">
                    @forelse($sessoes as $sessao)
                        @php
                            ...
                            if($sessao->status == 'closed') {
                                // 💡 ALTERAÇÃO AQUI: Usamos o total_sistema_esperado que calculamos no Controller
                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            <td class="p-6">
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center text-xl">
                                        👤
                                    </div>
                                    <div>
                            ...
                            <td class="p-6 text-right">
                                ...
                                @else
                                    <span class="text-[9px] font-black text-orange-500 uppercase animate-pulse italic">Aberto</span>
                                @endif
                            </td>
                                ...
                                @if($sessao->status == 'closed')
                                    ...
                                    @else
                                        <div class="flex flex-col items-center">
                                            ...
                                            <span class="text-[8px] text-red-600/50 uppercase font-black">Quebra (Falta)</span>
                                        </div>
                                    @endif
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-20 text-center text-gray-600 uppercase font-black italic tracking-widest text-xs">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            <div class="p-8 bg-gray-900/60 border border-gray-800 rounded-[2rem]">
                <h4 class="text-emerald-500 text-[10px] font-black uppercase tracking-widest mb-3 italic">Auditoria Inteligente</h4>
                <p class="text-[10px] text-gray-500 font-bold uppercase leading-relaxed">
                    Este relatório ignora falhas de gravação no banco e recalcula o <span class="text-white">Total Esperado</span> somando Mesas, PDV e Fundo de Reserva. Por isso, ele é mais preciso que o fechamento instantâneo.
                </p>
            </div>
            <div class="p-8 bg-gray-900/60 border border-gray-800 rounded-[2rem]">
                <h4 class="text-orange-500 text-[10px] font-black uppercase tracking-widest mb-3 italic">Conferência Real</h4>
                <p class="text-[10px] text-gray-500 font-bold uppercase leading-relaxed">
                    Se a diferença for de centavos, o sistema marca como <span class="text-emerald-500">"Bateu"</span>. Diferenças maiores indicam que o operador esqueceu de registrar uma venda ou deu troco errado.
                </p>
            </div>
        </div>
