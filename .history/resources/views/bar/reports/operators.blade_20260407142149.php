                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="text-gray-500 text-[10px] font-black uppercase tracking-widest border-b border-gray-800 bg-black/20">
                            ...
                            <th class="p-6 text-right text-orange-500 bg-orange-500/5">Comissão (5%)</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-800/50">
                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="p-6 text-right text-orange-500 font-black text-xl italic font-mono bg-orange-500/[0.02]">
