                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            @if(Auth::user()->role === 'admin')
                                {{-- Usuário Admin pode escolher entre Gestor ou Admin --}}
                            ...
                            @else
                                {{-- Usuário Gestor só pode criar outro Gestor --}}
                                <div class="w-full bg-gray-800/50 border border-gray-700 rounded-2xl p-4 text-gray-400 font-bold flex justify-between items-center select-none shadow-inner">
                                    <span class="uppercase text-xs tracking-widest">Gestor de Bar (Staff)</span>
                                    <span class="text-[9px] bg-orange-600/20 text-orange-500 border border-orange-500/20 px-2 py-1 rounded-lg font-black tracking-widest">PADRÃO</span>
                                </div>
                            ...
                            <p class="text-[9px] text-gray-600 font-bold uppercase tracking-widest mt-2 ml-2 italic">
                                * Gestores não possuem permissão para cadastrar Administradores.
                            </p>
                        </div>
                    </div>
