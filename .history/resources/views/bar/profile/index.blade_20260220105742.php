            ...
            <div class="bg-gray-900 border border-gray-800 rounded-[2.5rem] shadow-2xl overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4 pt-4">
                            <button type="submit"
                                class="px-8 py-3 bg-gray-800 hover:bg-gray-700 text-white text-xs font-black uppercase tracking-widest rounded-xl transition border border-gray-700 focus:outline-none">
                                Atualizar Senha
                            </button>
