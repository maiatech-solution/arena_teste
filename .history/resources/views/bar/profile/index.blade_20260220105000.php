    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <div>
                ...
                <p class="text-gray-500 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Configurações de acesso do operador</p>
            </div>
        </div>
        ...
        <div class="space-y-10">
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-[2.5rem] shadow-2xl overflow-hidden">
                <div class="p-8 border-b border-gray-800 bg-gray-800/20">
                    ...
                    <p class="text-gray-500 text-[10px] font-bold uppercase tracking-widest">Atualize seu nome e e-mail de acesso ao sistema</p>
                </div>
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4 pt-4">
                            ...
                            @if (session('status') === 'profile-updated')
                                <span class="text-green-500 text-xs font-bold uppercase animate-pulse">✅ Dados Atualizados!</span>
                            @endif
                        </div>
                    </form>
                </div>
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-[2.5rem] shadow-2xl overflow-hidden">
                <div class="p-8 border-b border-gray-800 bg-gray-800/20">
                    ...
                    <p class="text-gray-500 text-[10px] font-bold uppercase tracking-widest">Alterar senha de acesso ao PDV</p>
                </div>
                ...
                <div class="p-8">
                    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Confirmar Senha</label>
