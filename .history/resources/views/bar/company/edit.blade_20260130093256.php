                ...
                <form method="POST" action="{{ route('bar.company.update') }}" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2 group">
                            ...
                            <input type="tel" name="whatsapp_suporte" value="{{ old('whatsapp_suporte', $company->whatsapp_suporte) }}" required
                        ...
                        <div class="space-y-2 group">
                            ...
                            <input type="text" name="logradouro" value="{{ old('logradouro', $company->logradouro) }}" required
                                class="w-full bg-gray-800 border-none rounded-2xl p-4 text-white font-bold focus:ring-2 focus:ring-orange-500 shadow-inner transition-all">
                        </div>
                        ...
                        <div class="space-y-2 group">
                            ...
                            <input type="text" name="cidade" value="{{ old('cidade', $company->cidade) }}" required
                                class="w-full bg-gray-800 border-none rounded-2xl p-4 text-white font-bold focus:ring-2 focus:ring-orange-500 shadow-inner transition-all">
                        </div>
                    </div>
