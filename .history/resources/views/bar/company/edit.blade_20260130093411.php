        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-900 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-[2.5rem] border border-gray-800 p-10">
                ...
                <form method="POST" action="{{ route('bar.company.update') }}" class="space-y-10">
                    ...
                    <div class="pt-6">
                        <button type="submit"
                            class="w-full bg-orange-600 hover:bg-orange-500 text-white font-black py-5 rounded-2xl transition-all uppercase text-xs tracking-widest shadow-lg shadow-orange-600/20 active:scale-95 flex items-center justify-center gap-2">
