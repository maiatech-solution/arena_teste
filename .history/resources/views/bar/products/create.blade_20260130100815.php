        ...
        <div class="bg-gray-900 rounded-3xl border border-gray-800 p-8 shadow-2xl">
            <form action="{{ route('bar.products.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- 🚀 PASSO 2: GESTÃO DE INVENTÁRIO (O NOVO CAMPO) --}}
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div class="max-w-md">
                                ...
                                <p class="text-[10px] text-gray-500 font-bold uppercase leading-tight">
                                    Deseja que o sistema controle o saldo deste produto e emita alertas de estoque
                                    baixo?
                                </p>
                            </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="content_quantity" value="{{ old('content_quantity', 1) }}"
                            ...
                            class="w-full bg-gray-950 border-gray-800 rounded-xl text-white focus:border-orange-500 focus:ring-orange-500 p-3"
                            placeholder="Ex: 12">
                        <p class="text-[9px] text-gray-500 mt-1 uppercase font-bold italic">* Se vender por unidade,
                            mantenha 1.</p>
                    </div>
