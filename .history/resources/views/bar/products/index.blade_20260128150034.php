            ...
            <form action="{{ route('bar.products.record_loss') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="description" required class="w-full bg-gray-950 border-gray-800 rounded-xl text-white p-3 focus:border-red-500 outline-none" placeholder="Ex: Quebra">
                    </div>
                </div>
    ...
    <script>
        function confirmStatusChange(id, isActive) {
            ...
            if (reason !== null && reason.trim() !== "") {
                ...
                alert("O motivo é obrigatório para mudar o status.");
            }
        }
