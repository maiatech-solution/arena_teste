<x-bar-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(session('success'))
            <div class="mb-6 p-4 bg-green-900/50 border border-green-500 text-green-200 rounded-xl font-bold">
                {{ session('success') }}
            </div>
        @endif
        ...
        <div class="bg-gray-900 rounded-3xl border border-gray-800 overflow-hidden shadow-2xl">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-800">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="p-12 text-center text-gray-500 font-medium">Nenhum produto cadastrado ou encontrado.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
