                                ...
                                <div class="flex justify-between items-center relative z-10">
                                    <div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            {{-- AVISO SE NÃO CONTROLAR ESTOQUE --}}
            ...
            <div class="lg:col-span-1">
                <div id="confirmBox" class="bg-gray-900 p-8 rounded-[2.5rem] border border-gray-800 shadow-2xl sticky top-8 opacity-30 pointer-events-none transition-all duration-500">
                    ...
                    <form action="{{ route('bar.products.process_entry') }}" method="POST">
                        ...
                        {{-- SELETOR DE MODO (UNID vs FARDO) --}}
                        <div id="unitSelector" class="hidden mb-8 flex bg-gray-950 p-1.5 rounded-2xl border border-gray-800 shadow-inner">
                            <button type="button" onclick="setEntryMode('UN')" id="btn_un" class="flex-1 py-3 text-[10px] font-black uppercase rounded-xl transition-all bg-orange-600 text-white shadow-lg">
                                Unidades
                            </button>
                            <button type="button" onclick="setEntryMode('BULK')" id="btn_bulk" class="flex-1 py-3 text-[10px] font-black uppercase rounded-xl transition-all text-gray-600 hover:text-gray-300">
                                Fardo/Caixa
                            </button>
                        ...
                        <button type="submit" class="w-full py-6 bg-orange-600 hover:bg-orange-500 text-white font-black rounded-2xl transition-all shadow-xl shadow-orange-600/20 uppercase text-xs tracking-[0.2em] active:scale-95">
                            Finalizar Entrada
                        </button>
                    </form>
                </div>
