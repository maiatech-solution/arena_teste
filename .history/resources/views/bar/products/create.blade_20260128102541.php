    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <a href="{{ route('bar.products.index') }}"
                class="text-orange-500 hover:text-orange-400 text-sm font-bold flex items-center gap-2 mb-4">
        ...
        <div class="bg-gray-900 rounded-3xl border border-gray-800 p-8 shadow-2xl">
            <form action="{{ route('bar.products.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Código de Barras (Bipe
                            agora)</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Estoque Mínimo
                            (Alerta)</label>
