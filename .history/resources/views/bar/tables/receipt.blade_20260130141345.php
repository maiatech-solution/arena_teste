...
<body> <div class="text-center">
    ...
    <div class="no-print" style="margin-top: 40px; display: flex; align-items: center; flex-direction: column; gap: 12px;">
    ...
    <script>
        function enviarZapComPergunta() {
            ...
            if (fone !== null && fone !== "") {
                ...
                // Abre o Zap em nova aba
                window.open(urlZap, '_blank');

                // Volta ao mapa para liberar o sistema
                setTimeout(() => {
