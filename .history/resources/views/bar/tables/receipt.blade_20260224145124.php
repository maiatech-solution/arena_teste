    ...
    <div id="printableReceipt" class="receipt-container">
        ...
        <div style="font-family: 'Courier New', Courier, monospace; font-size: 12px;">
            @if ($order->discount_value > 0)
                ...
                <div class="flex-between" style="font-weight: bold; margin-bottom: 5px; color: #000;">
                    <span>DESCONTO:</span>
            ...
            <div class="flex-between"
                style="font-weight: bold; font-size: 16px; border-top: 1px solid #000; padding-top: 5px;">
