    ...
    <div class="py-12">
        ...
        <div id="printableReceipt" class="mx-auto bg-white p-6 shadow-xl receipt-container">
            <style>
                ...
                @media print {
                    /* Esconde tudo que pertence ao layout do bar */
                    body * { visibility: hidden; }
                    nav, aside, header, .no-print { display: none !important; }

                    /* Configura a página para bobina térmica */
                    @page {
                        size: 80mm auto;
                        margin: 0;
                    }

                    /* Força o cupom a aparecer no topo esquerdo */
                    #printableReceipt, #printableReceipt * {
                        visibility: visible !important;
                    }

                    #printableReceipt {
                        position: fixed; /* Usa fixed para ignorar o posicionamento do layout pai */
                        left: 0;
                        top: 0;
                        width: 80mm;
                        margin: 0 !important;
            ...
            <div style="font-size: 11px;">
                ...
                @if($order->customer_name)
                    <p style="margin: 2px 0;"><b>CLIENTE:</b> {{ strtoupper($order->customer_name) }}</p>
                @endif
            </div>
