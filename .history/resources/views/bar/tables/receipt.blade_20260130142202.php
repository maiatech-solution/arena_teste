    ...
    <div class="py-12">
        ...
        <div class="receipt-paper mx-auto bg-white p-6 shadow-xl" id="printableReceipt">
            <style>
                ...
                /* AJUSTE DE IMPRESSÃO - CORREÇÃO DE ALINHAMENTO */
                @media print {
                    /* Esconde TUDO do layout original */
                    body * { visibility: hidden; }
                    .no-print { display: none !important; }

                    /* Configura a página para não ter margens extras */
                    @page {
                        margin: 0;
                        size: auto;
                    }

                    /* Mostra apenas o cupom e força ele para o topo esquerdo */
                    #printableReceipt, #printableReceipt * {
                        visibility: visible;
                    }

                    #printableReceipt {
                        position: fixed; /* Fixa para ignorar rolagens do layout */
                        left: 0;
                        top: 0;
                        width: 80mm; /* Mantém a largura da bobina */
                        margin: 0;
                        padding: 5mm; /* Pequeno respiro nas bordas do papel */
                        box-shadow: none;
                        border: none;
            ...
            <table class="items-table">
                ...
                <tr>
                    <td style="padding-bottom: 4px;">
                        {{ $item->quantity }}x {{ substr($item->product->name, 0, 20) }}<br>
                        <span style="font-size: 10px; color: #444;">R$ {{ number_format($item->unit_price, 2, ',', '.') }} un</span>
                    </td>
