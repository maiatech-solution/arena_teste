<x-bar-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        @if (session('success'))
            <div class="bg-green-600 text-white p-4 rounded-2xl mb-6 font-black uppercase text-[10px] tracking-widest shadow-lg shadow-green-600/20">
                ✅ {{ session('success') }}
            </div>
        @endif

        @if (session('error'))
            <div class="bg-red-600 text-white p-4 rounded-2xl mb-6 font-black uppercase text-[10px] tracking-widest animate-pulse">
                ⚠️ {{ session('error') }}
            </div>
        @endif
