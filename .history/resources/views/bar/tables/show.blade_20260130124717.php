<x-bar-layout>
    ...
    <div id="modalPosFinalizar"
        ...
        <div class="bg-gray-900 border border-gray-800 p-10 rounded-[3rem] w-full max-w-md text-center shadow-2xl">
            ...
            <div class="flex flex-col gap-3">
                ...
                <button onclick="executarAcaoFinal('whatsapp')"
                    class="w-full py-4 bg-green-600 text-white font-black rounded-2xl uppercase text-[10px] tracking-widest hover:bg-green-500 transition-all">
                    📱 Enviar WhatsApp
                </button>
    ...
    <script>
        ...
        function abrirOpcoesFinais() {
            console.log("Abrindo opções de saída..."); // Debug para você ver no F12
            const modalOpcoes = document.getElementById('modalPosFinalizar');
            if (modalOpcoes) {
                modalOpcoes.classList.remove('hidden');
            } else {
                alert("Erro: Modal de opções não encontrado no HTML");
            }
        }
