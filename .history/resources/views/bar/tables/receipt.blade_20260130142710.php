<x-bar-layout>
    ...
    <div id="printableReceipt" class="receipt-container">
        <style>
            ...
            /* 🖨️ CONFIGURAÇÃO DE IMPRESSÃO PARA IMPRESSORA DE FOLHA (A4) */
            @media print {
                /* Esconde tudo do layout do sistema */
                body * { visibility: hidden; }
                nav, aside, header, .no-print { display: none !important; }

                /* Configura a página para remover margens do Windows */
                @page {
                    size: auto;
                    margin: 0mm;
                }

                /* Força o recibo para o topo esquerdo absoluto */
                ...
                #printableReceipt {
                    ...
                    margin: 0 !important;
                    padding: 10mm !important; /* Margem pequena para a impressora não cortar */
