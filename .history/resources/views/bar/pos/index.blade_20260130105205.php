<x-bar-layout>
    ...
    <div id="receiptModal"
        ...
        <div class="bg-white p-8 rounded-lg w-full max-w-[320px] shadow-2xl text-black font-mono text-sm"
            id="receiptContent">
            ...
            <div class="flex flex-col gap-2 no-print">
                <button onclick="window.print()"
                    class="w-full py-3 bg-gray-900 text-white font-black rounded-xl uppercase text-[10px] tracking-widest active:scale-95 shadow-lg shadow-gray-900/20 transition-all">🖨️
                    Imprimir</button>
                ...
                <button onclick="location.reload()"
                    class="w-full py-3 text-gray-400 font-black uppercase text-[10px] hover:text-black transition-colors">Nova
                    Venda</button>
            </div>
        </div>
    </div>
