<x-bar-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100vh-120px)]">
                ...
                @foreach ($products as $product)
                    <button
                        ...
                        <div class="absolute top-1.5 right-1.5">
                            <span
                                class="text-[7px] font-black px-1.5 py-0.5 rounded bg-gray-950/60 {{ $product->stock_quantity <= $product->min_stock ? 'text-red-500 animate-pulse' : 'text-gray-400' }}">
