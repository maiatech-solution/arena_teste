<x-bar-layout>
    ...
    <script>
        // 🧠 MEMÓRIA GLOBAL BLINDADA (window garante que não dê erro de declaração)
        window.supervisorMemoriaEmail = "";
        window.supervisorMemoriaPass = "";

        // Tenta reaproveitar a acaoPendente que o seu layout ou scripts anteriores já declararam
        ...
        function requisitarAutorizacao(callback) {
            ...
            // Atribui à variável global (sem usar let ou var aqui para evitar SyntaxError)
        ...
        function enviarComAutorizacao(idFormulario) {
            ...
            // Puxa obrigatoriamente da memória global que o monitor de input salvou
        ...
        // Clique fora para fechar (Universal)
