            ...
            <div class="mb-10 animate-in mt-12 fade-in duration-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @forelse($sessionsClosed ?? [] as $sessao)
                        @php
                            // 🎯 Lógica para separar o que é dinheiro do que é cortesia
                            // Isso assume que você já carrega os vouchers na model ou os filtra aqui
                            $totalDinheiroReal =
                                (float) ($sessao->total_vendas_sistema ?? 0) - (float) ($sessao->total_vouchers ?? 0);
                                    ...
                                    @if (($sessao->total_vouchers ?? 0) > 0)
                                        <div class="text-right">
                                            ...
                                            <p
                                                ...
                                                R$ {{ number_format($sessao->total_vouchers, 2, ',', '.') }}
                                            </p>
                                        </div>
                                    @endif
                                </div>
