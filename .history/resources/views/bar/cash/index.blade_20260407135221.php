<x-bar-layout>
            ...
            <div id="thermal-receipt"
                ...
                <div class="space-y-3 font-mono text-[11px]">
                    ...
                    <div class="flex justify-between"><span>DATA/HORA:</span>
                        <span>{{ now()->format('d/m/Y H:i') }}</span></div>
    ...
    @media print {
        ...
        #thermal-receipt {
            ...
            left: 0 !important;
            top: 0 !important;
            width: 72mm !important; /* Largura da bobina térmica */
        ...
        #thermal-receipt * {
            ...
            font-family: 'Courier New', Courier, monospace !important; /* Fonte de cupom */
        }
