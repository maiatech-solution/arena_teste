<x-bar-layout>
    ...
    <div id="modalAuthSupervisor"
        class="hidden fixed inset-0 bg-black/95 backdrop-blur-md z-[500] flex items-center justify-center p-4">
        <div class="bg-gray-900 border border-gray-800 p-8 rounded-[2.5rem] w-full max-w-sm text-center shadow-2xl">
            ...
            <p class="text-gray-500 text-[10px] uppercase font-bold tracking-widest mb-6">Ação restrita a Gestores ou
                Admins</p>
