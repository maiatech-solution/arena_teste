                        ...
                        <tbody class="divide-y divide-gray-800/50">
                            @forelse($movements as $mov)
                                @php
                                    ...
                                    // 3. Lógica para extrair o motivo da descrição (Concatenação do Controller)
                                    $partes = explode(' | MOTIVO: ', $mov->description);
                                    $tituloDescricao = $partes[0];
                                    $motivoTexto = $partes[1] ?? null;
                                @endphp
                                <tr class="hover:bg-white/[0.02] transition-colors group">
                                    ...
                                    <td class="p-6">
                                        ...
                                        {{-- Exibição do Motivo extraído da descrição --}}
                                        @if ($motivoTexto)
