<x-bar-layout>
    <div class="max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            ...
            {{-- BOTÕES DE AÇÃO COM TRAVA DE SEGURANÇA (IGUAL AO ESTOQUE) --}}
            @if ($openSession)
                <div class="flex flex-wrap gap-3">
                    {{-- SANGUIA: Pede login e só depois abre o modal --}}
                    ...
                    {{-- REFORÇO: Pede login e só depois abre o modal --}}
                    ...
                    {{-- FECHAMENTO: Pede login e só depois abre o modal --}}
    ...
    @include('bar.partials.modal-auth')
