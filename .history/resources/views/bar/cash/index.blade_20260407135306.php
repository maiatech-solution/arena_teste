        ...
        @if (session('success') && (session('total_esperado_print') || str_contains(session('success'), 'Turno encerrado')))
            ...
            <style>
                @media print {
                    ...
                    /* 1. Esconde as DIVs principais e o layout do sistema */
                    nav,
                    header,
                    footer,
                    x-bar-layout,
                    ...
                    /* 2. Garante que o body e o container do recibo fiquem visíveis */
                    body,
                    html {
                    ...
                    /* 3. Estilo do Cupom Térmico */
                    #thermal-receipt {
                        display: block !important;
                        visibility: visible !important;
                        position: static !important;
                        /* Static ajuda a renderizar no topo do papel */
                        width: 100% !important;
                    ...
                    /* 4. Força o texto a aparecer mesmo se o navegador tentar economizar tinta */
                    #thermal-receipt * {
                        color: black !important;
                        display: block !important;
                    }

                    /* 5. Remove margens de página do navegador */
                    @page {
                        margin: 0;
                        size: auto;
                    }
