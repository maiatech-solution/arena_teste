                ...
                isCashierOpen().then(() => {
                    ...
                    var calendarInstance = new FullCalendar.Calendar(calendarEl, {
                        ...
                        eventDidMount: function(info) {
                            ...
                            info.el.classList.remove('fc-event-available', 'fc-event-recurrent',
                                'fc-event-quick', 'fc-event-pending', 'fc-event-paid',
                                'fc-event-no-show');
                            ...
                            // 5. CONFIRMADAS (Aqui entra a lógica de ATRASADA por horário)
                                ...
                                if (isPast && (status === 'confirmed' || status === 'confirmada')) {
                                    ...
                                    'fc-event-no-show'); // Usa o vermelho para alerta
                                    ...
                                    if (titleEl) {
                                        ...
                                        titleEl.innerHTML =
                                            '<span style="font-weight: 900;">ATRASADA</span> ' + titleEl
                                            .textContent;
                                    }
                                } else {
