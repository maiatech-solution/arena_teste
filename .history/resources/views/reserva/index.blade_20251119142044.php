    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateDayMarkers(calendar) {
            ...
            dayCells.forEach(dayEl => {
                ...
                let availableSlots = 0; // Contagem de slots FIXOS (Verdes)
                let reservedSlots = 0; // Contagem de reservas REAIS (Ocupados/Invisíveis)
                ...
                const finalAvailableSlots = Math.max(0, availableSlots - reservedSlots);
