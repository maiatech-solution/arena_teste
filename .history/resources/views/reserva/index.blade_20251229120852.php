...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* 🛑 CORREÇÃO DE COLISÃO: Força 100% de largura 🛑 */
        ...
        /* 🛑 BLOQUEIO DE CLIQUES EM EVENTOS NÃO DISPONÍVEIS 🛑 */
        .fc-timegrid-event:not(.fc-event-available) {
            pointer-events: none !important;
            display: none !important;
            /* Esconde reservas invisíveis que roubam clique */
        }
        ...
        .fc-timegrid-event.fc-event-available {
            ...
            /* 🎯 Z-INDEX ELEVADO PARA PERMITIR CLIQUE 🎯 */
            width: 100% !important;
            left: 0 !important;
            z-index: 50 !important;
            pointer-events: auto !important;
            /* Força o recebimento do clique */
        }
