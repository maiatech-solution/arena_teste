    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                {{-- Certifique-se de que o nome da rota no web.php seja exatamente 'bar.dashboard' --}}
                @if(Route::currentRouteName() !== 'bar.dashboard')
                    <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex items-center">
                        ...
                        <a href="{{ route('bar.pdv') }}"
                           ...
                           {{ request()->routeIs('bar.pdv')
                              ? 'text-orange-500 bg-orange-500/10 rounded-xl border-b-2 border-orange-500 shadow-[0_4px_12px_rgba(234,88,12,0.3)]'
