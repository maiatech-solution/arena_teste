<x-app-layout>
    ...
    <style>
        /* 1. CONTAINER E ESTRUTURA GERAL (CALENDÁRIO) */
        .calendar-container {
            max-width: 1000px;
            margin: 20px auto;
            padding: 10px;
        ...
        /* 2. MODAIS E OVERLAYS (COM PREFIXO S7 PARA NÃO QUEBRAR O SISTEMA) */
        .s7-modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
        ...
        /* Classe de visibilidade segura: substitui o .hidden genérico */
        .s7-hidden {
            display: none !important;
        }

        /* 3. ESTILIZAÇÃO DE EVENTOS (CORES DO FULLCALENDAR) */
        .fc-event-available {
        ...
        /* 5. AUTOCOMPLETE (DINÂMICO E COM EMPURRÃO DE LAYOUT) */
        .s7-autocomplete-wrapper {
            position: relative !important;
            transition: margin-bottom 0.3s ease;
            /* Faz o WhatsApp descer suave */
        }

        /* Classe ativada via JS para empurrar o WhatsApp quando a lista aparece */
        .s7-is-searching {
