<x-app-layout>
    ...
    <style>
        ...
        /* CORREÇÃO: Força o sumiço quando a classe hidden for aplicada via JS */
        .hidden {
        ...
        /* 5. AUTOCOMPLETE (AJUSTADO) */

        /* CORREÇÃO: O pai do autocomplete (a div do input) DEVE ser relative */
        .relative {
        ...
        #client-autocomplete-results {
            position: absolute;
            top: 100%;
            /* Faz a lista nascer exatamente onde acaba o input */
            left: 0;
            width: 100%;
            max-height: 200px;
            overflow-y: auto;
