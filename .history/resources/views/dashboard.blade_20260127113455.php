<x-app-layout>
    ...
    <div class="py-12">
        ...
        {{-- Modal de Agendamento Rápido (Responsivo & Com Autocomplete Inteligente) --}}
        <div id="quick-booking-modal" class="modal-overlay hidden" onclick="closeQuickBookingModal()">
            <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[95vh] flex flex-col transition-all duration-300 transform scale-100 mx-4 sm:mx-0"
                ...
                <div class="p-4 overflow-y-auto custom-scrollbar relative">
                    <form id="quick-booking-form" class="relative">
                        @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="p-3 border border-indigo-100 rounded-lg bg-indigo-50/50 flex items-center">
                                ...
                                <label for="is-recurrent" class="ml-3 text-sm font-bold text-indigo-700">Reserva
                        ...
                        {{-- Container de Resultados Dinâmico (Flutuante) --}}
                        <div id="client-autocomplete-results"
                            class="absolute z-[3000] bg-white border border-gray-300 rounded-lg shadow-2xl hidden max-h-48 overflow-y-auto w-full left-0">
                        </div>
                    </form>
                </div>
