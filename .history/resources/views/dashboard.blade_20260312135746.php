            ...
            async function sendCancellationRequest(reservaId, method, urlBase, reason, supervisorToken = null) {
                ...
                try {
                    ...
                    if (response.ok && result.success) {
                        ...
                        // 🚀 O SEGREDO DA ATUALIZAÇÃO ESTÁ AQUI:
                        if (window.calendar) {
                            // Passo A: Remove os eventos da memória local do navegador
                            window.calendar.removeAllEvents();

                            // Passo B: Pequeno delay (300ms) para o banco de dados processar a liberação
                            setTimeout(() => {
                                // Passo C: Busca os dados frescos do servidor (o slot estará verde agora)
