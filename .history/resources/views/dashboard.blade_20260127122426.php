<x-app-layout>
    ...
    `;
            ...
            // =========================================================
            // LÓGICA DE AUTOCOMPLETE COM EMPURRÃO DINÂMICO (LAYOUT ADAPTÁVEL)
            // =========================================================
            ...
            const collapseLayout = () => {
                if (nameWrapper) nameWrapper.classList.remove('is-searching');
            ...
            const expandLayout = () => {
                if (nameWrapper) nameWrapper.classList.add('is-searching');
                if (autocompleteResults) autocompleteResults.classList.remove('hidden');
            };

            /**
             * Função principal de busca de clientes
             */
            const performClientSearch = (inputElement) => {
                ...
                // ⚡ LIMPEZA IMEDIATA: Ao digitar, já recolhe o layout para esperar o novo resultado
                if (autocompleteResults) {
                    autocompleteResults.innerHTML = '';
                    autocompleteResults.classList.add('hidden');
                }
                ...
                debounceTimer = setTimeout(() => {
                    fetch(`/api/clientes/search?query=${encodeURIComponent(query)}&arena_id=${arenaId}`)
                        ...
                        .then(data => {
                            ...
                            // Se não houver dados, garante que o layout esteja recolhido
                    ...
                    `;
                            ...
                            // Se chegamos aqui com itens, expande o layout (empurra o WhatsApp)
            ...
            // 4. Fechar ao clicar fora do componente de nome
