<x-app-layout>
    ...
    `;
            ...
            // =========================================================
            // LÓGICA DE AUTOCOMPLETE DUPLO COM POSICIONAMENTO DINÂMICO
            // =========================================================
            ...
            const performClientSearch = (inputElement) => {
                    ...
                    fetch(`/api/clientes/search?query=${encodeURIComponent(query)}&arena_id=${arenaId}`)
                        ...
                        .then(data => {
                            ...
                            if (data && data.length > 0) {
                                // --- AJUSTE DE POSIÇÃO DINÂMICA ---
                                // Isso evita que a lista cubra o campo de WhatsApp quando você digita no Nome
                        ...
                        `;
                                    ...
                                    div.onclick = () => {
                                        ...
                                        if (phone && clientContactInput()) {
                                            ...
                                            // (Define sinal R$ 0,00 automaticamente se for VIP)
                ...
                }, 350); // Delay de 350ms para poupar o servidor
            };

            // --- Registro dos Eventos ---

            // Aplica o listener nos dois campos simultaneamente
            ...
            // Fecha os resultados ao clicar fora deles (Global)
