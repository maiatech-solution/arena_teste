<x-app-layout>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            if (!form) {
                console.warn(`⚠️ Atenção: Formulário #${formId} não encontrado.`);
                return;
            }
            ...
            form.addEventListener('submit', function(e) {
                ...
                console.group(`🚀 Processando envio: ${formId}`);

                const btn = document.getElementById(btnId);
                const spinner = document.getElementById(spinnerId);

                // Busca o ID da reserva dentro deste form específico
                ...
                console.log("ID Identificado:", idValue);

                let targetUrl = urlTemplate;
                if (targetUrl.includes('{id}')) {
                    if (!idValue || idValue === "" || idValue === "1") {
                        console.error("❌ Erro: ID inválido para a URL.");
                        alert("Erro: ID da reserva não encontrado. Feche o modal e tente novamente.");
                        console.groupEnd();
                        return;
                    }
