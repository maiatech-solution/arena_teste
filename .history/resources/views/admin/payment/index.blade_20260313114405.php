                                ...
                                @forelse ($reservas as $reserva)
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-center text-sm space-x-1">
                                            {{-- Só mostra os botões se houver valor a pagar E se ainda não foi marcado como Dívida ou Falta --}}
                                            @if ($restanteNoDia > 0.01 && $reserva->status !== 'debt' && $reserva->status !== 'no_show')
                                                {{-- Botão BAIXAR --}}
                                                <button type="button"
                                            ...
                                            @elseif($reserva->status === 'debt')
                                                {{-- Texto que aparece no lugar dos botões para o sistema saber que está resolvido --}}
                                                <span
                                                    class="text-[10px] font-bold text-purple-600 uppercase italic">Enviado
                                                    para Pendências</span>
                                            @endif
                                        </td>
                                    @empty
                                    <tr>
