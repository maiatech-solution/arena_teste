                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    ...
                                    // 🎯 SE FOR FECHAMENTO: ABRE O MODAL E SAI DA FUNÇÃO IMEDIATAMENTE
                                    if (formId === 'closeCashForm') {
                                        ...
                                        // Reseta a trava e USA RETURN PARA NÃO EXECUTAR O ALERT ABAIXO
                                        window.caixaProcessandoGlobal[formId] = false;
                                        return;
                                    }

                                    // ✅ Este alert só vai aparecer para as outras telas (Pagamento, Falta, etc)
                                    setTimeout(() => {
                                        alert(json.message);
