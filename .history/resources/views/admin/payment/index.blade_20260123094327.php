<x-app-layout>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div
                                ...
                                <p class="text-sm text-red-700 dark:text-red-400">
                                    O caixa do dia <span id="reopenCashDateDisplay" class="font-black underline"></span>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            // DEBUG: Se o formulário de dívida não for encontrado, ele vai te avisar na hora
            if (!form) {
                if (formId === 'debtForm') console.warn('Aviso: debtForm não encontrado no DOM ainda.');
                return;
            }
            ...
            form.addEventListener('submit', function(e) {
                ...
                // DEBUG: Se chegar aqui, o problema de "não acontece nada" ACABOU
                console.log('Formulário ' + formId + ' disparado com sucesso!');
                ...
                if (!id && urlTemplate.includes('{id}')) {
                    alert('Erro: ID da reserva não encontrado no modal.');
                    return;
                }
