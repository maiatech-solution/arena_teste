<x-app-layout>
    ...
    <script>
        ...
        if (!window.__CAIXA_SCRIPT_LOADED) {
            ...
            pagamentos ? date = 2026 - 04 - 07 & arena_id = 1 : 3214🚀 Scripts de Caixa carregados e travas resetadas!
                pagamentos ? date = 2026 - 04 - 07 & arena_id = 1 :
                3277✅ Todos os formulários registrados com blindagem e seletores de origem!
                pagamentos ? date = 2026 - 04 - 07 & arena_id = 1 : 3569🚀 Scripts de Caixa carregados!
                pagamentos ? date = 2026 - 04 - 07 & arena_id = 1 : 3130🔍 DEBUG RESPOSTA: {
                    success: true,
                    message: 'Caixa fechado com sucesso!'
                }
            message: "Caixa fechado com sucesso!"
            success: true[[Prototype]]: Object
