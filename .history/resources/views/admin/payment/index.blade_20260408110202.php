            ...
            function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
                ...
                form.onsubmit = function(e) {
                    ...
                    const enviarParaOServidor = (tokenRecebido = null) => {
                        ...
                        console.log(`[DEBUG] Enviando formulário ${formId} para: ${targetUrl}`);
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(res => res.json())
                            .then(json => {
                                console.log("[DEBUG] Resposta completa do servidor:", json);
                                ...
                                if (json.success) {
                                    ...
                                    if (json.resumo) {
                                        ...
                                        // FUNÇÃO DE FORMATAÇÃO COM FALLBACK PARA UNDEFINED
                                        const f = (val) => {
                                        ...
                                        console.log("[DEBUG] Preenchendo modal com resumo:", r);

                                        // IDs de destino no HTML - Garanta que esses IDs existam!
                                        const campos = {
                                            'resumoArena': r.arena,
                                            'resumoData': "FECHAMENTO: " + (r.data || '---'),
                                            'resumoDinheiro': f(r.gaveta || r
                                            .dinheiro), // Aceita os dois nomes
                                            'resumoPix': f(r.banco || r.pix), // Aceita os dois nomes
                                        ...
                                        for (const [id, valor] of Object.entries(campos)) {
                                            ...
                                            if (el) {
                                                ...
                                                console.warn(`[DEBUG] Elemento #${id} não encontrado no DOM.`);
                                            }
                                        }

                                        const difWrapper = document.getElementById('resumoDiferencaWrapper');
                                        if (difWrapper) {
                                            difWrapper.style.color = (parseFloat(r.diferenca) < 0) ? '#dc2626' :
                                                '#16a34a';
                                        }
                                        ...
                                        if (modalResumo) {
                                            ...
                                            console.log("[DEBUG] Modal de resumo exibido com sucesso.");
                                        } else {
                                            console.error(
                                                "[DEBUG] Erro Crítico: Elemento #modalResumoFechamento não existe!"
                                                );
                                            alert(
                                                "Fechado com sucesso, mas o modal de resumo não foi encontrado.");
                                        }
