...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg p-5 flex flex-col justify-between border border-gray-200 dark:border-gray-700">
        <form method="GET" action="{{ route('admin.payment.index') }}" id="dateFilterForm">
            ...
            <div class="flex items-center justify-between mb-1">
                <label for="date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg p-5 border border-gray-200 dark:border-gray-700">
