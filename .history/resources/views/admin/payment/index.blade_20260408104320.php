    ...
    <script>
        ...
        if (!window.__CAIXA_SCRIPT_LOADED) {
            ...
            function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
                ...
                // Evita duplicar o listener caso a função seja chamada mais de uma vez
                ...
                form.onsubmit = function(e) {
                    ...
                    const enviarParaOServidor = (tokenRecebido = null) => {
                        ...
                        // Substitui IDs na URL se necessário (para rotas Laravel)
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    // 🛑 BLOQUEIO DE MODAIS E BACKDROPS ANTERIORES (Limpa a tela)
                                    document.querySelectorAll(
                                        '.modal-backdrop, .modal, #modalSenha, #closeCashModal').forEach(
                                        el => {
                                    ...
                                    // 🎯 SE TIVER RESUMO (FECHAMENTO DE CAIXA), MOSTRA O MODAL DE IMPRESSÃO
                                    if (json.resumo) {
                                        const r = json.resumo;
                                        ...
                                        if (modalResumo) {
                                            ...
                                            modalResumo.style.zIndex = '10001';
                                        }

                                        // Reseta o estado global sem recarregar (permitindo interagir com o modal)
                                        window.caixaProcessandoGlobal[formId] = false;

                                    } else {
                                        // Comportamento para outros formulários (Sucesso padrão)
