            ...
            function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
                ...
                form.onsubmit = function(e) {
                    ...
                    const enviarParaOServidor = (tokenRecebido = null) => {
                        ...
                        // 1. LIMPEZA TOTAL DE MODAIS ANTES DE COMEÇAR
                        if (typeof window.fecharModalAutorizacao === 'function') window.fecharModalAutorizacao();

                        // Remove qualquer backdrop (fundo escuro) que o Bootstrap ou Tailwind possa ter deixado
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    // 2. LIMPEZA PÓS-SUCESSO (Garante que o modal de credenciais suma de vez)
                                    ...
                                    if (json.resumo) {
                                        ...
                                        difElem.style.color = r.diferenca < 0 ? 'red' : 'green';

                                        // 3. ABRE O RESUMO (Com z-index garantido via CSS)
                    ...
                    // Removi 'closeCashForm' daqui para ele não disparar o modal de credenciais em cima do resumo
