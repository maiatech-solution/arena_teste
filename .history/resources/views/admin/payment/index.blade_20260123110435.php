                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-4">
                    ...
                    <div
                        ...
                        <div class="mt-1 text-2xl font-black text-amber-700 dark:text-amber-400">
                            R$
                            {{ number_format(
                                $reservasDoDia->where('status', 'completed')->whereIn('payment_status', ['unpaid', 'partial'])->sum(function ($r) {
                                        // Calcula o valor total (final_price ou price) menos o que já foi pago
