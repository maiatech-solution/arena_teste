    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div class="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
            ...
            <div class="mt-1 text-2xl font-bold text-cyan-700 dark:text-cyan-300">
                {{-- Usamos $totalReceived que é o saldo líquido do dia, confirmando o valor de R$ 250,00 --}}
                R$ {{ number_format($totalReceived ?? 0, 2, ',', '.') }}
            </div>
            <div class="text-xs text-gray-500">
                {{-- Mantemos a informação sobre o total de sinais para contexto, usando a variável dedicada --}}
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @forelse (isset($financialTransactions) ? $financialTransactions : [] as $transaction)
                            ...
                            @endphp
                            <tr>
                                {{-- CORREÇÃO: Adiciona a checagem de nulo (paid_at) para evitar a quebra do Blade se a transação for futura --}}
