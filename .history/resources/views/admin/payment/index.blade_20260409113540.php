<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            {{-- 👇 ESTA DIV É A QUE MANTÉM OS CARDS LADO A LADO --}}
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                {{-- CARD 2: REFORÇOS (Mantenha o código que você já tem aqui) --}}
                <div
                ...
                {{-- CARD 3: SANGRIA (Mantenha o código que você já tem aqui) --}}
                <div
