...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-5 gap-2 xl:gap-4">

        {{-- CARD 1: SALDO EM CAIXA (LÍQUIDO REAL) --}}
        <div class="bg-green-600 dark:bg-green-700 overflow-hidden shadow-md rounded-lg p-3 xl:p-4 flex flex-col justify-center border-b-4 border-green-900">
            <div class="flex items-center justify-between">
                <div class="text-[9px] xl:text-[10px] font-bold text-green-50 uppercase tracking-tighter truncate">
                    💰 Saldo Caixa
                </div>
            </div>
        ...
        <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-300 dark:border-indigo-800 overflow-hidden shadow-md rounded-lg p-3 xl:p-4 flex flex-col justify-center text-center sm:text-left">
            <div class="text-[9px] xl:text-[10px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-tighter truncate">
                🎾 Receita Agenda
            </div>
            <div class="mt-1 text-sm sm:text-lg xl:text-2xl font-extrabold text-indigo-700 dark:text-indigo-300 truncate">
        ...
        <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-800 overflow-hidden shadow-md rounded-lg p-3 xl:p-4 flex flex-col justify-center text-center sm:text-left">
            <div class="text-[9px] xl:text-[10px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-tighter truncate">
                ⏳ Pendente
            </div>
            <div class="mt-1 text-sm sm:text-lg xl:text-2xl font-extrabold text-yellow-700 dark:text-yellow-300 truncate">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-md rounded-lg p-3 xl:p-4 flex flex-col justify-center text-center sm:text-left">
            <div class="text-[9px] xl:text-[10px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-tighter truncate">
                📅 Ativas
            </div>
            <div class="mt-1 text-sm sm:text-lg xl:text-2xl font-extrabold text-gray-900 dark:text-white truncate">
                {{ $totalReservasDia }}
            </div>
            <div class="hidden sm:block text-[8px] xl:text-[9px] text-gray-500 mt-1 leading-none">
                Total de jogos.
        ...
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 overflow-hidden shadow-md rounded-lg p-3 xl:p-4 flex flex-col justify-center text-center sm:text-left">
            <div class="text-[9px] xl:text-[10px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-tighter truncate">
                ❌ Faltas
            </div>
            <div class="mt-1 text-sm sm:text-lg xl:text-2xl font-extrabold text-red-700 dark:text-red-300 truncate">
                {{ $noShowCount }}
            </div>
            <div class="hidden sm:block text-[8px] xl:text-[9px] text-gray-500 mt-1 leading-none">
                Registradas hoje.
