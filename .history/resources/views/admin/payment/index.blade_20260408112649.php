                ...
                form.onsubmit = function(e) {
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                ...
                                if (json.success) {
                                    ...
                                    // 🎯 SE FOR FECHAMENTO: SÓ ABRE O MODAL E PARA TUDO.
                                    if (formId === 'closeCashForm') {
                                        ...
                                        return; // 🛑 MATAMOS O ALERT AQUI.
                                    }

                                    // Para outros forms, apenas recarrega sem mensagem
                                    window.location.reload();

                                } else {
                                    // Mantenha o alert apenas para ERROS
                    ...
                    if (userRole === 'colaborador' && acoesRestritas.includes(formId)) {
                        window.requisitarAutorizacao(token => {
                            console.log("Autorização recebida do supervisor. Enviando...");
