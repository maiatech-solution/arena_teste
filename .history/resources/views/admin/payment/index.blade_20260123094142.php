    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            form.addEventListener('submit', function(e) {
                e.preventDefault();
                console.log('📩 Disparando formulário:', formId);

                const btn = document.getElementById(btnId);
                const spinner = document.getElementById(spinnerId);
                const error = document.getElementById(errorId);

                // Mapeamento exato de onde cada formulário busca seu ID
                const id = document.getElementById('modalReservaId')?.value || // Pagamento
                    document.getElementById('noShowReservaId')?.value || // No-Show
                    document.getElementById('debtReservaId')?.value || // Pagar Depois
                    document.getElementById('closeCashArenaId')?.value || // Fechar Caixa
                    document.getElementById('reopenCashArenaId')?.value || // Reabrir Caixa
                    '';

                console.log('🔑 ID identificado para a rota:', id);
