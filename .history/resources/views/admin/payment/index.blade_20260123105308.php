    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Busca o ID da reserva priorizando o campo da dívida
                const idInput = form.querySelector('#debtReservaId') ||
                    form.querySelector('#modalReservaId') ||
                    form.querySelector('[name="reserva_id"]');

                if (!idInput || !idInput.value) {
                    alert("Erro: Não foi possível identificar o ID da reserva.");
                    return;
                }

                // Substitui {id} ou {reserva} na URL para garantir compatibilidade com as rotas do Laravel
