                            ...
                            .then(json => {
                                if (json.success) {
                                    ...
                                    if (formId === 'closeCashForm') {
                                        // 1. Fecha o modal de preenchimento
                                        closeCloseCashModal();

                                        // 2. Alimenta o modal de resumo com os valores da tela
                                        ...
                                        // 3. Mostra o modal de resumo final
                                        document.getElementById('modalResumoFinal').classList.replace('hidden',
                                            'flex');

                                        // 🛑 INTERRUPÇÃO: Aqui impedimos o alert e o reload automático
                                        window.caixaProcessandoGlobal[formId] = false;
                                        return;
                                    }

                                    // ✅ Para os outros formulários (Pagamento, No-Show), mantém o alert padrão
                                    setTimeout(() => {
                                        alert(json.message);
