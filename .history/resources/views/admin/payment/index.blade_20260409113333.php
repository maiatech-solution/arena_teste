<x-app-layout>
    ...
    <div class="py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div id="js_global_data">
                        ...
                        @php
                            $pendenciasDeHoje = $reservas
                                ->filter(function ($r) use ($financialTransactions) {
                                    ...
                                    return round($totalPagoReserva, 2) < round($valorDevido, 2) &&
                                        $r->status !== 'no_show';
                                })
                                ->count();
                        @endphp
                        ...
                        <input type="hidden" id="js_totalPending" value="{{ $pendenciasDeHoje }}">
                        {{-- 🎯 Aqui destrava o botão --}}
                ...
                border-l-4 {{ $isActive ? 'border-l-indigo-600' : 'border-l-indigo-400' }}">
                                ...
                                <div class="truncate">
                                    ...
                                    <span
                                        ...
                                        @php
                                            // 🎯 AJUSTE: Pegamos o total da arena e subtraímos o que for voucher especificamente dela
                                            $totalRealArena =
                                                $arena->total -
                                                $financialTransactions
                                                    ...
                                                    ->sum('amount');
                                        @endphp
                                        R$ {{ number_format($totalRealArena, 2, ',', '.') }}
                                    </span>
                                </div>
                        ...
                        @empty
                            <div
                                ...
                                <p class="text-xs text-gray-400 italic font-medium">Nenhum faturamento registrado para
                                    as
                                    arenas nesta data.</p>
                            </div>
                        @endforelse
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @forelse ($reservas as $reserva)
                                        @php
                                            ...
                                            $somaOrfa = (float) \App\Models\FinancialTransaction::whereNull(
                                                'reserva_id',
                                            )
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap">
                                                ...
                                                {{-- 🎯 ADICIONE ESTE BLOCO --}}
                                                @if ($reserva->transactions->where('payment_method', 'voucher')->count() > 0)
                                                    <span
                                                        class="block text-[9px] text-purple-500 font-bold uppercase mt-1 italic">
                                                        ✨ Cortesia/Voucher
                                                    </span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-center text-sm space-x-1">
                                                ...
                                                @elseif($reserva->status === 'no_show')
                                                    <span
                                                        class="text-[10px] font-bold text-red-600 uppercase italic">Falta
                                                        Registrada</span>
                                                @endif
                                            </td>
                                        @empty
                ...
                {{-- CARD 9: TABELA DE TRANSAÇÕES FINANCEIRAS (AUDITORIA DE CAIXA) --}}
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-bold text-gray-500 uppercase">Hora
                                        </th>
                                        <th class="px-4 py-3 text-left text-xs font-bold text-gray-500 uppercase">ID
                                        </th>
                                        <th
                                    ...
                                    @forelse ($groupedTransactions as $reservaId => $transactions)
                                        ...
                                        @foreach ($transactions as $transaction)
                                            ...
                                            <tr class="{{ $rowClass }} transition duration-150">
                                                ...
                                                <td
                                                    class="px-4 py-3 text-right text-sm font-mono {{ $amountClass }}">
                                                    {{ $amount < 0 ? '-' : '' }} R$
                ...
                {{-- CARD 10: HISTÓRICO DE FECHAMENTOS (AUDITORIA DE DIVERGÊNCIAS POR ARENA) --}}
                ...
                {{-- CARD 11: LINK PARA RELATÓRIOS (NAVEGAÇÃO ESTRATÉGICA) --}}
                                ...
                                <div class="mt-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-1">
                                            ...
                                            <input type="number" step="0.01" id="modalFinalPrice"
                                                name="final_price" oninput="calculateAmountDue()" required
                                        ...
                                        <p class="text-[10px] text-gray-400 mt-1 italic">* Altere para aplicar
                                            descontos ou
                                            acréscimos finais.</p>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="relative mt-1">
                                            ...
                                            <input type="number" step="0.01" id="modalAmountPaid"
                                                name="amount_paid" oninput="checkManualOverpayment()" required
                                        ...
                                        <label class="relative flex items-start cursor-pointer group">
                                            ...
                                            <span class="ml-3 text-left">
                                                <span
                                                    ...
                                                    série futura</span>
                                                <span
                                                    class="block text-[11px] text-gray-500 dark:text-gray-400 italic">
        ...
        <div id="closeCashModal"
            class="fixed inset-0 z-50 hidden overflow-y-auto flex items-center justify-center p-4">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
        ...
        <div id="openCashModal"
            class="fixed inset-0 z-50 hidden overflow-y-auto flex items-center justify-center p-4">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onclick="closeOpenCashModal()">
            </div>
