                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    ...
                                    // Esconde o modal de fechar caixa, o modal de senha e qualquer fundo escuro
                                    ...
                                    // --- 2. VERIFICAÇÃO DE RESUMO ---
                                    if (json.resumo) {
                                        // Se caiu aqui, NÃO PODE TER ALERT.
                                        // Preenchemos o modal de resumo:
                                        const r = json.resumo;
                                        ...
                                        if (modalResumo) {
                                            ...
                                            modalResumo.style.setProperty('z-index', '99999',
                                            'important'); // Força ficar em cima
                                        }
                                    } else {
                                        // Só mostra alert se for um sucesso comum (sem resumo de impressão)
                                        if (json.message) alert(json.message);
                                        window.location.reload();
                                    }
                                } else {
                                    // Trata erro de validação ou erro de senha
