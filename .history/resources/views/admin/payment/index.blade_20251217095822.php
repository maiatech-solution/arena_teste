                                ...
                                @forelse ($reservas as $reserva)
                                    @php
                                        ...
                                        if (isset($highlightReservaId) && $reserva->id == $highlightReservaId) {
                                            ...
                                            $rowHighlight =
                                                'bg-yellow-100 dark:bg-yellow-900/50 border-l-8 border-yellow-500';
                                        } elseif ($eHoje) {
                                            // DESTAQUE DE HOJE (Azul com borda lateral grossa)
                                            $rowHighlight =
                                                'bg-blue-100/70 dark:bg-blue-900/40 border-l-8 border-blue-600';
                                        } else {
                                    ...
                                    <tr class="{{ $rowHighlight }} transition duration-150">
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-sm font-bold text-gray-900 dark:text-white">
                                            <div class="flex flex-col">
                                                <span>{{ \Carbon\Carbon::parse($reserva->start_time)->format('H:i') }}
                                                    -
                                                    {{ \Carbon\Carbon::parse($reserva->end_time)->format('H:i') }}</span>
                                                @if ($eHoje)
                                                    <span
                                                        class="text-[10px] text-blue-700 dark:text-blue-400 font-extrabold uppercase mt-1">●
                                                        Agendado p/ Hoje</span>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-sm text-right font-bold text-gray-900 dark:text-white">
                                            {{ number_format($total, 2, ',', '.') }}
                                        </td>
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-sm text-right text-green-600 font-bold">
                                            {{ number_format($pago, 2, ',', '.') }}
                                        </td>
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-sm text-right font-black {{ $restante > 0 ? 'text-red-600' : 'text-gray-400' }}">
