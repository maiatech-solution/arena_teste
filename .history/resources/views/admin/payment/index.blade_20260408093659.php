    ...
    <script>
        ...
        if (!window.__CAIXA_SCRIPT_LOADED) {
            ...
            function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
                ...
                // 🛡️ TRAVA DE VINCULAÇÃO: Impede que o evento seja registrado mais de uma vez
                    ...
                    const enviarParaOServidor = (tokenRecebido = null) => {
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                ...
                                if (json.success) {
                                    // 🖨️ SÓ IMPRIME SE O CONTROLLER ENVIAR O RESUMO
                                    if (json.resumo) {
                            ...
                            `;
                                    ...
                                    // Se não houver resumo, mostra apenas 1 alerta
                                    alert(json.message);
                                    window.location.reload();
                                } else {
