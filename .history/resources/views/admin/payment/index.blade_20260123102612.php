<x-app-layout>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            // Garante que o evento de submit seja limpo antes de registrar
            form.onsubmit = null;

            form.addEventListener('submit', function(e) {
                e.preventDefault();

                console.log(`%c 🚀 TENTANDO ENVIAR: ${formId} `, 'background: #f59e0b; color: #fff');

                const btn = document.getElementById(btnId);
                const spinner = document.getElementById(spinnerId);

                // Busca o ID dentro do formulário atual
                ...
                // Validação de ID para rotas dinâmicas
                if (targetUrl.includes('{id}')) {
                    if (!id || id === '0' || id === '') {
                        alert('Erro: ID da reserva não identificado. Feche o modal e tente novamente.');
                        return;
                    }
                ...
                fetch(targetUrl, {
                    ...
                    .catch(err => {
                        ...
                        alert('Não foi possível processar: ' + err.message);
