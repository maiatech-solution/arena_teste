        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div
                ...
                <div id="valor-liquido-total-real" class="mt-1 text-2xl font-black text-white truncate">
                    ...
                    R$ {{ number_format($financialTransactions->where('payment_method', '!=', 'voucher')->sum('amount'), 2, ',', '.') }}
                </div>
            ...
            <div
                ...
                <div class="mt-1 text-2xl font-black text-emerald-700 dark:text-emerald-500">
                    R$
                    {{-- 🎯 AJUSTE: Filtrar para não somar voucher no reforço se existir --}}
                    {{ number_format($movimentacoes->where('type', 'reforco')->where('payment_method', '!=', 'voucher')->sum('amount'), 2, ',', '.') }}
                </div>
            ...
            <div
                ...
                <div class="mt-1 text-2xl font-black text-red-600 dark:text-red-500">
                    R$
                    {{-- 🎯 AJUSTE: Filtrar para não somar voucher na sangria --}}
                    {{ number_format(abs($movimentacoes->whereIn('type', ['sangria', 'refund', 'no_show_penalty'])->where('amount', '<', 0)->where('payment_method', '!=', 'voucher')->sum('amount')),2,',','.') }}
                </div>
