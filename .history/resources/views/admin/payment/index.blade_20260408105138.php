                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    ...
                                    // Esconde modais abertos, fundos escuros e o modal de senha do gestor
                                    ...
                                    if (json.resumo) {
                                        ...
                                        // EXIBE O MODAL DE RESUMO COM PRIORIDADE
                                        ...
                                        // Importante: Libera o processamento para permitir interação, mas não recarrega
                                        window.caixaProcessandoGlobal[formId] = false;

                                    } else {
                                        // --- 3. SUCESSO COMUM (SEM RESUMO) ---
                                        // Só mostra alert se a mensagem existir e não for undefined
                                    ...
                                    // Trata erros (Validação, Senha incorreta, etc)
