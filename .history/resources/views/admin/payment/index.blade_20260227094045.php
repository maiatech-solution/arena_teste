<x-app-layout>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            // 🛑 Limpa qualquer onsubmit anterior para evitar duplicidade
            form.onsubmit = null;
            ...
            form.onsubmit = function(e) {
                ...
                const enviarParaOServidor = (tokenRecebido = null) => {
                    ...
                    // 🛡️ TRAVA DE SEGURANÇA TRIPLA:
                    // 1. Verifica se o botão está desativado
                    // 2. Verifica se o formulário já está em "modo processamento"
                    if (btn && (btn.disabled || form.dataset.sending === 'true')) {
                    ...
                    if (btn) {
                        btn.disabled = true;
                        btn.style.pointerEvents = 'none'; // Impede cliques físicos
                        btn.dataset.originalText = btn.innerText;
                        btn.innerText = "PROCESSANDO...";
                    }
                    if (spinner) spinner.classList.remove('hidden');

                    // Marca o formulário como "enviando"
                    ...
                    fetch(targetUrl, {
                        ...
                        .then(json => {
                            if (json.success) {
                                ...
                                // ❌ ERRO DE VALIDAÇÃO (Servidor barrou o valor)
                                alert(json.message || 'Erro ao processar.');

                                // REABERTURA: Só acontece se o servidor negar explicitamente
                        ...
                        .catch(err => {
                            ...
                            alert('Erro na comunicação. O registro pode ter sido salvo. Recarregue a página.');
