<x-app-layout>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            // Remover qualquer listener anterior para evitar duplicidade
            form.onsubmit = null;
            ...
            form.addEventListener('submit', function(e) {
                ...
                // --- TESTE DE VIDA ---
                console.log("🔥 CLICK DETECTADO NO FORM:", formId);
                ...
                if (!idInput || !idInput.value) {
                    alert("❌ Erro: ID da reserva não encontrado no formulário.");
                    return;
                }
