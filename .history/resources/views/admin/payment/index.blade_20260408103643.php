                ...
                form.onsubmit = function(e) {
                    ...
                    const enviarParaOServidor = (tokenRecebido = null) => {
                        ...
                        fetch(targetUrl, {
                            ...
                            .then(json => {
                                if (json.success) {
                                    // 🛑 BLOQUEIO DE MODAIS E BACKDROPS ANTERIORES
                                    ...
                                    // 🎯 SE TIVER RESUMO, IGNORA O ALERT E MOSTRA O MODAL
                                    if (json.resumo) {
                                        const r = json.resumo;
                                        ...
                                        // IMPORTANTE: NÃO existe alert(json.message) aqui!
                                    } else {
                                        // Só mostra alert se NÃO for o fechamento com resumo
                                        if (json.message) alert(json.message);
                                        window.location.reload();
                                    }
                                } else {
                                    // Se deu erro, avisa o motivo
