        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- 🛑 NOVO: DEBUG DISPLAY DO SALDO GLOBAL --}}
                    @if(isset($totalGlobalBalance))
                    <div class="mb-4 p-3 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-300 dark:border-indigo-600 rounded">
                        <p class="text-sm font-semibold text-indigo-700 dark:text-indigo-300">
                            SALDO GLOBAL (ACUMULADO DE TODAS AS DATAS): R$ {{ number_format($totalGlobalBalance, 2, ',', '.') }}
                        </p>
                    </div>
                    @endif
                    {{-- 🛑 FIM DEBUG --}}
