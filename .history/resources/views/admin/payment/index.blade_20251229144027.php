...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-5 gap-2 lg:gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-md rounded-lg p-2 sm:p-4 flex flex-col justify-center ">
            <div class="text-[8px] sm:text-[10px] font-medium text-gray-700 dark:text-gray-300 uppercase tracking-tighter truncate">
                📅 Ativas
            </div>
