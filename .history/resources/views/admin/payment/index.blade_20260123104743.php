<x-app-layout>
    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            form.onsubmit = null; // Limpa qualquer lixo de memória
            form.addEventListener('submit', function(e) {
                ...
                // Busca o ID da reserva - Tenta o específico da dívida primeiro
                ...
                // Substitui {reserva} ou {id} para bater com seu web.php
                const targetUrl = urlTemplate.replace('{id}', idValue).replace('{reserva}', idValue);
