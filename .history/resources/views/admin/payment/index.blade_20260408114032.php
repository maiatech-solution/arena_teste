            ...
            <head>
                <style>
                    ...
                    body {
                        ...
                        width: 72mm; /* Ajuste para 48mm se sua impressora for pequena */
                        margin: 0 auto;
                        padding: 10px;
                        font-size: 12px;
                        line-height: 1.2;
                    ...
                    .border-b { border-bottom: 1px dashed #000; margin-bottom: 6px; padding-bottom: 4px; }
                    .mb-4 { margin-bottom: 12px; }
                    .mt-4 { margin-top: 12px; }
                    /* Garante que a lista de horários fique legível */
                    #resumoListaAgendamentos div { margin-bottom: 2px; }
