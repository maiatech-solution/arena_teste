<x-app-layout>
    ...
    <script>
        ...
        document.getElementById('paymentForm').addEventListener('submit', function(e) {
            ...
            // Rota ajustada conforme web.php: admin/pagamentos/{reserva}/finalizar
            fetch(`/admin/pagamentos/${id}/finalizar`, {
                    method: 'POST',
        ...
        document.getElementById('noShowForm').addEventListener('submit', function(e) {
            ...
            // Rota ajustada conforme web.php: admin/reservas/{reserva}/no-show
            fetch(`/admin/reservas/${id}/no-show`, {
                    method: 'POST',
                    body: new FormData(this),
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
