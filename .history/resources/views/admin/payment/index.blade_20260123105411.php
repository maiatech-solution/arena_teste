    ...
    <script>
        ...
        function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const idValue = dataObj.reserva_id || document.getElementById('debtReservaId')?.value || document
                    .getElementById('modalReservaId')?.value;
                ...
                fetch(targetUrl, {
                    ...
                    .text(); // Pegamos como texto primeiro caso o PHP dê erro de sintaxe (HTML)
                        ...
                        try {
                            ...
                            console.log(text); // Isso aqui vai mostrar o erro do PHP se houver
