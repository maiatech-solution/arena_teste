<x-app-layout>
    ...
    @forelse ($reservas as $reserva)
        @php
            ...
            // 4. Definição de Cores e Labels de Status
            $statusClass = '';
            $statusLabel = '';
            ...
            // 5. Lógica de Destaque da Linha (Prioridade para Dashboard ID, depois Hoje)
            if (isset($highlightReservaId) && $reserva->id == $highlightReservaId) {
                ...
                $rowHighlight = 'bg-indigo-50/50 dark:bg-indigo-900/10 border-l-4 border-indigo-400';
            } else {
