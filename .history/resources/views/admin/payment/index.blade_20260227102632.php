                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($reservas as $reserva)
                                    @php
                                       ...
                                       $canPay = $restante > 0.01 && !in_array($reserva->status, ['canceled', 'rejected']);
                ...
                const enviarParaOServidor = (tokenRecebido = null) => {
                    ...
                    fetch(targetUrl, {
                        ...
                        .then(json => {
                            ...
                            // 🛡️ FILTRO DE ELIMINAÇÃO: Se a frase aparecer, ignoramos o alert e resetamos
                            if (mensagemServidor.includes("já foi baixada anteriormente")) {
                                ...
                                return; // Mata a execução aqui para não chegar no alert
                            }
