        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @else
                ...
                <div
                    ...
                    {{-- BLOCO DE STATUS E CONTROLE DE CAIXA --}}
                    <div
                        ...
                        {{-- 1. DADOS OCULTOS PARA O JS (Sempre visíveis no HTML) --}}
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between">
                            ...
                            <div
                                ...
                                @else
                                    Status do Caixa:
                                    @if (!request('arena_id'))
                                        <span class="ml-2 font-bold text-amber-500 italic">Selecione uma
                                            unidade...</span>
                                    @elseif($totalPending > 0)
                                        <span class="ml-2 font-bold text-red-500 animate-pulse">Aguardando Recebimentos
                                            (R$ {{ number_format($totalPending, 2, ',', '.') }})</span>
                                    @else
