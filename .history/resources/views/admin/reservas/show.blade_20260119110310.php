<x-app-layout>
    ...
    <div class="py-12">
        ...
        {{-- 1. MODAL DE BLOQUEIO PARA MANUTENÇÃO --}}
                    ...
                    <form id="maintenanceForm">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="maintenance_reason" required rows="2"
                                class="w-full rounded-2xl border-gray-200 dark:bg-gray-900 dark:border-gray-700 text-sm focus:ring-pink-500 dark:text-white"
                                placeholder="Ex: Reparo rede..."></textarea>
                        </div>

                        <div class="flex flex-col sm:flex-row gap-3">
                            <button type="button" onclick="closeMaintenanceModal()"
                                class="flex-1 px-4 py-4 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 rounded-2xl font-black uppercase text-[10px]">Cancelar</button>
                            <button type="submit" id="btnConfirmMaintenance"
                                class="flex-[2] px-4 py-4 bg-pink-600 text-white rounded-2xl font-black uppercase text-[10px] shadow-lg shadow-pink-200 dark:shadow-none">Confirmar
                                e Bloquear</button>
                        </div>
                    </form>
                </div>
        ...
        {{-- 2. MODAL DE REATIVAÇÃO (FINALIZAR MANUTENÇÃO) --}}
                ...
                <div
                    ...
                    <form method="POST" action="{{ route('admin.reservas.reativar_manutencao', $reserva->id) }}"
                        ...
                        <button type="submit" name="action" value="restore_client"
                            ...
                            <div
                                class="bg-indigo-100 dark:bg-indigo-900 p-2 rounded-lg group-hover:bg-white transition text-xl">
                                👤</div>
                            <div>
                                <span
                        ...
                        <button type="submit" name="action" value="release_slot"
                            ...
                            <div
                                class="bg-emerald-100 dark:bg-emerald-900 p-2 rounded-lg group-hover:bg-white transition text-xl">
                                🔓</div>
                            <div>
                                <span
