                                        ...
                                        <div class="flex flex-col space-y-2 items-end">
                                            ...
                                            <form action="{{ route('admin.reservas.rejeitar', $reserva->id) }}" method="POST" class="w-full text-right">
                                                ...
                                                <button type="submit" title="Rejeitar Agendamento"
                                                    ...
                                                    class="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded-md text-xs font-bold transition shadow-md w-full sm:w-auto flex items-center justify-center">
>
                                                    Rejeitar
                                                </button>
                                            </form>
