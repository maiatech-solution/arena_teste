<x-app-layout>
    ...
    <script>
        ...
        // =========================================================================
        // 🛠️ LÓGICA DE MANUTENÇÃO (REGRAS DE ESTORNO)
        // =========================================================================
        ...
        function openMaintenanceModal(reservaId, paidAmount) {
            ...
            // Atualiza os labels de valor pago no modal
            ...
            // Se não houver valor pago, esconde as opções financeiras
            if (amount <= 0) {
        ...
        document.getElementById('maintenanceForm').addEventListener('submit', function(e) {
            ...
            fetch(`/admin/reservas/${window.currentReservaMaintenanceId}/mover-manutencao`, {
                ...
                .finally(() => {
                    ...
                    submitBtn.textContent = 'Confirmar e Bloquear';
                });
        });
