<x-app-layout>
    ...
    <script>
        ...
        safeAddEventListener('maintenanceForm', 'submit', function(e) {
            ...
            const url = "{{ route('admin.reservas.mover_manutencao', ':id') }}".replace(':id', window.currentReservaMaintenanceId);
            ...
            .then(async response => {
                ...
                // Removido o window.open.
                // A página apenas recarrega e o Controller Laravel enviará o link via Session.
                window.location.reload();
            })
