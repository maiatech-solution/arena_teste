<x-app-layout>
                    ...
                    <div
                        ...
                        @if ($reserva->status === 'maintenance')
                            <div class="space-y-3">
                                ...
                                {{-- Agora este botão apenas abre o modal de escolha --}}
    ...
    <script>
        ...
        // ESCUTA ÚNICA PARA O FORMULÁRIO DE MANUTENÇÃO
        document.getElementById('maintenanceForm').addEventListener('submit', function(e) {
            ...
            // Gera a URL correta baseada na sua rota 'admin.reservas.mover_manutencao'
