<x-app-layout>
    ...
    <div class="py-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        {{-- 2. CASO A RESERVA ESTEJA CONFIRMADA OU CONCLUÍDA (Fluxo normal ou Paga) --}}
        ...
        <div id="maintenanceModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4 py-6">
                ...
                <div
                    class="relative bg-white dark:bg-gray-800 rounded-[2.5rem] max-w-md w-full p-8 shadow-2xl border border-pink-100 dark:border-pink-900/30 transform transition-all">

                    <div class="mb-6">
                        <div
                            class="w-12 h-12 bg-pink-100 dark:bg-pink-900/30 rounded-full flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-gray-500 mt-2 leading-relaxed">
                            Você está removendo o cliente deste horário para realizar uma manutenção. O slot ficará
                            <span class="text-pink-600 font-bold">ROSA</span> no calendário.
                        </p>
                    </div>

                    <div id="refundWarning"
                        class="hidden mb-6 p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-800 rounded-2xl">
                        <div class="flex items-start gap-3">
                            <span class="text-lg">⚠️</span>
                            <div>
                                <p class="text-[10px] font-black text-orange-600 uppercase tracking-widest mb-1">
                                    Atenção: Dinheiro em Caixa</p>
                                <p class="text-xs text-orange-700 dark:text-orange-300">
                                    Este cliente já pagou <span class="font-bold">R$ <span
                                            id="warningPaidAmount"></span></span>. Lembre-se de realizar o estorno
                                    manual no caixa após confirmar o bloqueio.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="maintenanceForm">
                        <div class="mb-6">
                            ...
                            <textarea id="maintenance_reason" required rows="3"
    ...
    <script>
        ...
        window.currentReservaMaintenanceId = null;
        ...
        /**
         * Abre o modal de manutenção e verifica se há necessidade de estorno manual
         */
        function openMaintenanceModal(reservaId, paidAmount) {
            const warning = document.getElementById('refundWarning');
            const warningAmount = document.getElementById('warningPaidAmount');
            const amount = parseFloat(paidAmount);

            if (amount > 0) {
                warningAmount.textContent = amount.toLocaleString('pt-BR', {
        ...
        /**
         * Envia a requisição de mudança para status 'maintenance'
         */
        document.getElementById('maintenanceForm').addEventListener('submit', function(e) {
            ...
            if (reason.length < 5) {
                alert('Por favor, descreva o motivo da manutenção (mínimo 5 caracteres).');
                return;
            }
            ...
            fetch(`/admin/reservas/${window.currentReservaMaintenanceId}/mover-manutencao`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
                ...
                .then(data => {
                    ...
                    alert(data.message || 'Horário bloqueado para manutenção com sucesso!');
                    window.location.reload();
                })
                .catch(error => {
                    console.error('Erro:', error);
