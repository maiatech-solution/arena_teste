<x-app-layout>
    ...
    <script>
        ...
        // =========================================================================
        // 🛠️ LÓGICA DE MANUTENÇÃO (BLOQUEIO E ESTORNO)
        // =========================================================================
        ...
        /**
         * Listener único para o formulário de manutenção
         */
        document.getElementById('maintenanceForm').addEventListener('submit', function(e) {
            e.preventDefault();

            const reason = document.getElementById('maintenance_reason').value;
            // Captura qual rádio está selecionado (refund, credit ou none)
            ...
            fetch(`/admin/reservas/${window.currentReservaMaintenanceId}/mover-manutencao`, {
                ...
                .then(data => {
                    ...
                    alert(data.message || 'Horário bloqueado com sucesso!');
                    window.location.reload();
                })
                .catch(error => {
                    console.error('Erro:', error);
