                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        @if (session('whatsapp_link'))
                            <div
                                class="p-4 bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-100 dark:border-emerald-800 rounded-2xl mb-2 flex items-center justify-between group animate-pulse">
                        ...
                        {{-- Aqui continuariam os @if status pending, confirmed, etc. que você enviará no próximo bloco --}}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="maintenanceModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4 py-6">
            ...
            <div
                ...
                <div class="mb-6">
                    <div class="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center mb-4"><span
                            class="text-2xl">🛠️</span></div>
                    <h3 class="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Manutenção
                    </h3>
                ...
                <form id="maintenanceForm">
                    <div id="financeActionSection" class="mb-6 space-y-4">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-1">Ação
                            Financeira</label>
                        <div class="grid grid-cols-1 gap-2">
                            <label
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="font-black text-xs uppercase text-gray-700 dark:text-gray-300">Devolver
                                        Valor (Caixa)</span>
                                </div>
                                <p class="text-[10px] text-pink-600 mt-2 font-bold uppercase italic">⚠️ R$ <span
                                        class="paid-amount-label">0,00</span> sairá do caixa.</p>
                            </label>
                            @if ($reserva->is_recurrent)
                                <label
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span
                                            class="font-black text-xs uppercase text-gray-700 dark:text-gray-300">Mover
                                            p/ Próximo Horário</span>
                                    </div>
                                </label>
                            @endif
                        </div>
                    ...
                    <div class="mb-6">
                        <label
                            class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2 px-1">Motivo</label>
                    ...
                    <div class="flex gap-3">
                        <button type="button" onclick="closeMaintenanceModal()"
                            class="flex-1 py-4 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 rounded-2xl font-black uppercase text-[10px]">Cancelar</button>
                        <button type="submit" id="btnConfirmMaintenance"
                            class="flex-[2] py-4 bg-pink-600 text-white rounded-2xl font-black uppercase text-[10px] shadow-lg">Confirmar</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-6">
            ...
            <div
                ...
                <div class="mb-6 text-center">
                    ...
                    <h3 class="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Concluir
                        Manutenção</h3>
                ...
                <form method="POST" action="{{ route('admin.reservas.reativar_manutencao', $reserva->id) }}"
                    ...
                    <button type="submit" name="action" value="restore_client"
                        class="w-full p-4 border-2 border-indigo-50 rounded-2xl hover:bg-indigo-50 dark:hover:bg-gray-700 transition text-left flex items-start gap-4 group">
                        ...
                        <div>
                            ...
                            <span class="block text-[10px] text-gray-500">O horário volta para o cliente anterior como
                                'Confirmado'.</span>
                        </div>
                    </button>
                    <button type="submit" name="action" value="release_slot"
                        class="w-full p-4 border-2 border-emerald-50 rounded-2xl hover:bg-emerald-50 dark:hover:bg-gray-700 transition text-left flex items-start gap-4 group">
                        ...
                        <div>
                            <span
                                ...
                                Horário (Vago)</span>
                            <span class="block text-[10px] text-gray-500">Dixa a quadra livre para novos
                                agendamentos.</span>
                        </div>
                    </button>
                    <button type="button" onclick="closeReactivateModal()"
                        class="w-full py-2 text-gray-400 text-[10px] font-bold uppercase hover:text-gray-600 transition">Cancelar</button>
                </form>
            </div>
        </div>
    </div>
