        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="flex flex-col mb-8 space-y-4">
                    ...
                    <div class="flex flex-col md:flex-row items-end md:items-end space-y-4 md:space-y-0 md:space-x-6 w-full">
                            ...
                            <div class="flex space-x-2 w-full md:w-auto items-end flex-grow md:flex-grow-0">
                                <div class="flex-grow">
                                    ...
                                    <input type="text" name="search" id="search" value="{{ $search ?? '' }}"
                                        ...
                                        class="px-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500 shadow-sm transition duration-150 ">
                                </div>
