                                    ...
                                    <div id="slots-container-{{ $dayOfWeek }}" class="slots-container mt-2"
                                        ...
                                        @foreach ($slots as $index => $slot)
                                            ...
                                            <div class="slot-item slot-container space-x-4 p-3 bg-white dark:bg-gray-600"
                                                ...
                                                {{-- Checkbox de Slot Ativo e Botão de Remover --}}
    ...
    <script>
        ...
        document.querySelectorAll('.add-slot-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // 🛑 CORRIGIDO: Recriando a estrutura original que usa grid para Início/Fim/Preço
                const newSlotHtml = `
                    <div class="slot-item slot-container space-x-4 p-3 bg-white dark:bg-gray-600"
                            data-day="${dayOfWeek}"
                            data-index="${index}"
                        ...
                        {{-- LINHA 1: CHECKBOX ATIVO E BOTÃO REMOVER --}}
                        <div class="flex items-center space-x-4 mb-2">
                            <div class="flex items-center">
                                <input type="checkbox" name="configs[${dayOfWeek}][${index}][is_active]"
                        ...
                        {{-- LINHA 2: GRID DE INPUTS (lado a lado) --}}
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-1">
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400">Início</label>
