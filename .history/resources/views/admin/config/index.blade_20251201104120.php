    ...
    <script>
        ...
        async function executeDeleteAction(isConfirmed) {
            ...
            try {
                ...
                alert('Erro de conexão com o servidor. Verifique se a URL de rota está correta no arquivo de rotas do Laravel.'); // Mensagem de erro aprimorada
                closeDeleteConfigModal();
            } finally {
                // 🛑 CORREÇÃO: Garante que o botão de confirmação volte ao estado normal no final
                confirmBtn.disabled = false;
                confirmBtn.textContent = 'Continuar';
            }
        }
        ...
        async function toggleStatus(id) {
            ...
            try {
                ...
                alert('ERRO DE CONEXÃO COM O SERVIDOR (Network Error): Certifique-se de que sua rota `admin.config.update_status` está definida corretamente no Laravel e que o servidor está rodando.'); // Mensagem aprimorada
