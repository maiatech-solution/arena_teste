<x-app-layout>
    ...
    <script>
        ...
        // 🆕 NOVO: Função para alternar o estado de todos os inputs de um dia, incluindo o novo campo de meses.
            ...
            checkbox.addEventListener('change', function() {
                ...
                if (!isDisabled) {
                    ...
                    if (firstSlotCheckbox) {
                        ...
                        // Se não houver slots, adiciona um novo placeholder
