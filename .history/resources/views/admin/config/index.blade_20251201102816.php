<x-app-layout>
    ...
    <style>
        ...
        /* Corrigido para remover 'flex items-center space-x-4' que causou o problema */
        .slot-container {
            ...
            display: block; /* Garante que os slots fiquem um abaixo do outro */
        }
        ...
        /* Estilo para garantir que o contêiner de slots não force a visualização horizontal */
        .slots-container {
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg mb-8">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    {{-- ✅ ATUALIZADO: MENSAGEM DE PROCESSO AUTOMÁTICO (agora mencionando 6 meses) --}}
                    ...
                    <form id="config-form" action="{{ route('admin.config.store') }}" method="POST">
                        ...
                        {{-- 🛑 CAMPO HIDDEN CRÍTICO: Define a recorrência automática de 6 meses --}}
                                ...
                                <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-inner">
                                    ...
                                    <div id="slots-container-{{ $dayOfWeek }}" class="slots-container mt-2"
                                        ...
                                        @foreach ($slots as $index => $slot)
                                            ...
                                            <div class="slot-item slot-container space-x-4 p-3 bg-white dark:bg-gray-600"
                                                    data-day="{{ $dayOfWeek }}"
                                                    data-index="{{ $index }}"
                                                ...
                                                {{-- 🛑 Corrigido: Removido 'flex items-center' da div pai deste slot para que os campos fiquem alinhados verticalmente --}}
                        ...
                        <div class="flex justify-start mt-8">
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                                Salvar Configuração Semanal (Recorrência de 6 Meses)
                            </button>
                        </div>
                    </form>
                </div>
            ...
            {{-- ... Tabela de Gerenciamento de Reservas Fixas Geradas ... --}}
             <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg">
                 <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                      ...
                      {{-- ✅ ATUALIZADO: Mensagem para a recorrência de 6 meses --}}
                      <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Esta lista exibe os slots fixos gerados para os próximos **6 meses**. Use os botões para desativar (manutenção) ou reativar.</p>
    ...
    <script>
        ...
        document.querySelectorAll('.day-toggle-master').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                if (!isDisabled) {
                    container.style.display = 'block'; // 🛑 CORRIGIDO: Voltando para 'block' para o layout vertical
        ...
        document.querySelectorAll('.add-slot-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // 🛑 CORRIGIDO: Atualizando o HTML do novo slot para seguir a estrutura original
                const newSlotHtml = `
                    <div class="slot-item slot-container space-x-4 p-3 bg-white dark:bg-gray-600"
                            data-day="${dayOfWeek}"
                            data-index="${index}"
        ...
        async function executeDeleteAction(isConfirmed) {
            ...
            try {
                ...
                if (document.getElementById('delete-config-modal').classList.contains('hidden')) { // Evita reativar o botão se o modal for reaberto
                    confirmBtn.disabled = false;
                    confirmBtn.textContent = 'Continuar';
                }
            }
