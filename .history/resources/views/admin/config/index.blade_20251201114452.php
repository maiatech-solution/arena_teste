    ...
    <script>
        ...
        async function toggleStatus(id) {
            ...
            try {
                ...
                // Se o Laravel redirecionar (302), a próxima linha falha com SyntaxError.
                const result = await response.json();
                ...
                if (response.ok && result.success) {
                    ...
                    // Resposta do servidor falhou (ex: 403, 404, 500)
                ...
                alert('ERRO DE CONEXÃO COM O SERVIDOR (Network Error): Certifique-se de que sua rota `admin.config.update_status` está definida corretamente no Laravel e que o servidor está rodando.');
