<x-app-layout>
    ...
    <script>
        ...
        // 🆕 CORRIGIDO: Função para alternar o estado de todos os inputs de um dia, incluindo o novo campo de meses.
        function updateDayInputsState(dayOfWeek, isDisabled) {
            ...
            if (monthInputContainer) {
                // Alterna a visibilidade do container de meses
        ...
        document.querySelectorAll('.add-slot-btn').forEach(button => {
            button.addEventListener('click', function() {
                // Previne ação se o botão estiver desabilitado (segurança)
                ...
                // Pega o índice atual
                let index = nextIndex[dayOfWeek];

                // Se, por algum motivo, o índice não foi inicializado (bug de carregamento), use a contagem atual.
