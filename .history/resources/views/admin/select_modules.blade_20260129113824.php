    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-950 to-black">
        ...
        <div class="max-w-5xl w-full text-center space-y-12">
            <div class="space-y-4">
                ...
                <p class="text-gray-400 text-lg">
                    @if($company->modules_active > 0)
                        Gerenciamento de Plano: Faça o upgrade para liberar novos recursos!
                    @else
            ...
            <form action="{{ route('modules.store') }}" method="POST" class="flex flex-wrap justify-center gap-8">
                ...
                {{-- MÓDULO 1: ARENA --}}
                {{-- Só mostra se o plano for 0 (novo) ou se ele JÁ FOR arena (1) --}}
                @if($company->modules_active == 0 || $company->modules_active == 1)
                ...
                {{-- MÓDULO 2: PDV --}}
                {{-- Só mostra se o plano for 0 (novo) ou se ele JÁ FOR PDV (2) --}}
                @if($company->modules_active == 0 || $company->modules_active == 2)
                ...
                {{-- MÓDULO 3: COMBO FULL --}}
                {{-- Sempre disponível, a menos que já esteja ativo --}}
