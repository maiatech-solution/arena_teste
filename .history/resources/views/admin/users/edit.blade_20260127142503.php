            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    <div id="blacklist-container"
                        ...
                        <div class="flex items-center">
                            {{--
                LÓGICA À PROVA DE ERROS:
                1. Se o formulário acabou de ser enviado, usa o valor do 'old'.
                2. Se é o carregamento inicial, verifica se o texto no banco contém 'blacklist' (ignorando maiúsculas).
            --}}
                            <input type="checkbox" name="is_blacklisted" id="is_blacklisted" value="1"
                                @if (old('_token') ? old('is_blacklisted') : str_contains(strtolower($user->customer_qualification ?? ''), 'blacklist')) checked @endif
