        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    {{-- 🚫 Container Blacklist (Integrado com customer_qualification) --}}
                    <div id="blacklist-container"
                        ...
                        <div class="flex items-center">
                            {{--
            Lógica do Checkbox:
            1. Verifica se houve um envio anterior (old('is_blacklisted'))
            2. Se não, verifica o valor real no banco ($user->customer_qualification)
        --}}
                            <input type="checkbox" name="is_blacklisted" id="is_blacklisted" value="1"
                                {{ old('is_blacklisted') == '1' || (!old('_token') && $user->customer_qualification === 'blacklist') ? 'checked' : '' }}
