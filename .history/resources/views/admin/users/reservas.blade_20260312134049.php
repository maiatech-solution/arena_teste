        ...
        document.getElementById('series-cancellation-form').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                if (response.ok && result.success) {
                    ...
                    setTimeout(() => {
                        console.log('Série removida, redirecionando para garantir slots verdes...');

                        // OPÇÃO A: Recarregar a mesma página (Lista de Usuário)
                        // window.location.href = window.location.href;

                        // OPÇÃO B: Ir direto para o Calendário (Melhor fluxo para o Gestor)
