<x-app-layout>
    ...
    <script>
        ...
        // 🛑 CRÍTICO: Rota de cancelamento de série, adaptada no routes/web.php
        const CANCEL_SERIES_API_URL = '{{ route("admin.reservas.cancel_client_series", [":masterId" => ""]) }}';
        ...
        document.getElementById('series-cancellation-form').addEventListener('submit', async function(event) {
            ...
            // Substitui o placeholder no JS (precisa ser feito manualmente porque é uma rota DELETE/POST)
