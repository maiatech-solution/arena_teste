                ...
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition duration-150">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                        ...
                        <a href="{{ route('admin.payment.index', ['reserva_id' => $reserva->id]) }}"
                           class="ml-2 inline-block text-center bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 text-xs font-semibold rounded-md shadow transition duration-150">
                            Pagar
                        </a>
                    </td>
                </tr>
