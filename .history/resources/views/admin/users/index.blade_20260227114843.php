    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                @php
                    $filterBaseClasses =
                        'px-5 py-2 rounded-lg text-sm font-medium transition duration-150 ease-in-out shadow-md border-2 border-transparent';
                @endphp
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-6 space-y-3 sm:space-y-0">
                    ...
                    <div class="flex space-x-3 w-full sm:w-auto justify-end">
                        {{-- 1. Botão Novo Gestor: Apenas Admin e Gestor podem ver/criar --}}
                        ...
                        {{-- 2. Botão Novo Cliente: Admin e Gestor podem ver/criar (Colaborador não) --}}
                        @if (Auth::user()->role === 'admin' || Auth::user()->role === 'gestor')
                        ...
                        {{-- Se o usuário for 'colaborador', este espaço ficará vazio, impedindo que ele crie qualquer conta --}}
                    </div>
                </div>
                ...
                <div
                    class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                    Usuário (Nome/Email)</th>
                                ...
                                <th
                                    ...
                                    WhatsApp</th>
                                <th
                                    class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider min-w-[150px]">
                                    Ações</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="mt-1">
                                            @if ($user->role === 'admin')
                                                <span
                                                    class="px-2 inline-flex text-[10px] leading-4 font-semibold rounded-full bg-red-100 text-red-800 uppercase">Admin</span>
                                            @elseif ($user->role === 'gestor')
                                                <span
                                                    class="px-2 inline-flex text-[10px] leading-4 font-semibold rounded-full bg-indigo-100 text-indigo-800 uppercase">Gestor</span>
                                            @else
                                                <span
                                                    class="px-2 inline-flex text-[10px] leading-4 font-semibold rounded-full bg-green-100 text-green-800 uppercase">Cliente</span>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 font-mono">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div id="modal-content"
                ...
                <div class="flex flex-col items-center">
                    <div
                        class="flex items-center justify-center h-14 w-14 rounded-full bg-red-100 dark:bg-red-900/30 mb-4">
                        <svg class="h-8 w-8 text-red-600 dark:text-red-500" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="mt-3">
                        <p class="text-sm text-gray-600 dark:text-gray-400 text-center">
                            ...
                            <span id="username-placeholder"
                                class="font-black text-gray-900 dark:text-white uppercase"></span>?
                        </p>

                        {{-- Nota de Rastreabilidade --}}
                        <p
                            class="mt-4 p-2 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-800 rounded text-xs text-yellow-700 dark:text-yellow-500 text-center italic">
                            Atenção: Reservas vinculadas a este ID (ID: <span id="userid-placeholder"></span>) podem
                            perder a referência direta.
                        </p>

                        <p
                            class="mt-3 text-sm font-bold text-red-600 dark:text-red-400 text-center uppercase tracking-widest">
                            Ação Irreversível
                        </p>
                    </div>
                </div>
