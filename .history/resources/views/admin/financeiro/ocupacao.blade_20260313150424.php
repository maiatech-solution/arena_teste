<x-app-layout>
  <style>
    @media print {
        /* 1. Configuração da Folha: Paisagem */
        @page {
            size: A4 landscape;
            margin: 1cm;
        }
        ...
        /* 4. A MÁGICA: Cada dia começa em uma folha nova */
        .relative.break-inside-avoid {
            page-break-after: always !important; /* Força nova página após cada dia */
        ...
        /* 6. Grid de Cards: 4 colunas em Paisagem aproveitam melhor o espaço */
        .grid {
        ...
        /* 7. Estilo dos Cards (Sem quebras internas) */
        ...
        /* 8. Esconde a borda lateral decorativa que buga na impressão */
