<x-app-layout>
  <style>
    @media print {
        ...
        /* 3. Ajuste do Grid para não cortar */
        .grid {
            display: grid !important;
            grid-template-columns: repeat(2, 1fr) !important; /* Força 2 cards por linha no papel */
            gap: 10px !important;
            border: none !important;
        }

        /* 4. Estilização dos Cards no Papel */
        ...
        * {
        ...
        /* 6. Corrige o corte lateral da Timeline */
        .ml-8 { margin-left: 20px !important; }
