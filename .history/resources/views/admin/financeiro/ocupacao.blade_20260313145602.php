<x-app-layout>
  <style>
    @media print {
        /* 1. Limpeza radical de interface */
        nav, header, aside, footer, .print\:hidden, #ocupacaoFilterForm {
            display: none !important;
        }

        /* 2. Configurações da Folha */
        @page {
            margin: 1.5cm 1cm; /* Aumentamos a margem superior e inferior */
            size: A4 portrait;
        }
        ...
        /* 3. Evita que o relatório seja cortado no final */
        #reportContent {
            display: block !important;
            width: 100% !important;
            padding-bottom: 50px !important; /* Margem de segurança para a última página */
        }

        /* 4. Grid de 2 colunas para não espremer */
        .grid {
        ...
        /* 5. Proteção total contra quebra de card no meio */
        #reportContent div.bg-white {
            position: relative !important;
            display: block !important;
            page-break-inside: avoid !important; /* Antigo, mas ainda funcional */
            break-inside: avoid !important;       /* Padrão moderno */
            border: 1px solid #e5e7eb !important;
            border-radius: 12px !important;
            margin-bottom: 5px !important;
        }

        /* 6. Força os identificadores de data a não ficarem sozinhos no fim da página */
        .sticky {
            position: relative !important;
        ...
        /* 7. Ajuste de escala para garantir que caiba */
        .max-w-7xl {
