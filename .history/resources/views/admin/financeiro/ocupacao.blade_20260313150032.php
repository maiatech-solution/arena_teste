<x-app-layout>
  <style>
    @media print {
        ...
        /* 2. Permite que o conteúdo flua entre páginas sem saltos bruscos */
        .py-8 { padding: 0 !important; }

        /* Contêiner de cada dia */
        .relative.break-inside-avoid {
            display: block !important;
            page-break-inside: auto !important; /* Permite que um dia comece numa página e termine em outra */
            break-inside: auto !important;
            margin-bottom: 30px !important;
        }

        /* 3. Título do Dia: Não deixa ele ficar sozinho no fim da página */
        .sticky {
        ...
        /* 4. O GRID: O segredo para múltiplos dias */
        .grid {
        ...
        /* 5. OS CARDS: Eles não podem ser cortados ao meio */
        #reportContent div.bg-white {
            page-break-inside: avoid !important; /* O card nunca quebra */
        ...
        /* 6. Remove a linha lateral (border-l-2) que costuma bugar na impressão */
        .border-l-2 {
        ...
        /* 7. Força escala para caber mais informação */
