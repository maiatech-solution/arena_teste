    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div id="reportContent" class="bg-white dark:bg-gray-800 p-8 shadow-lg rounded-xl border border-gray-100 dark:border-gray-700">
                ...
                {{-- RESUMO FINANCEIRO TOTAL (Rodapé Preto) --}}
                <div class="mt-10 p-8 bg-black dark:bg-gray-900 rounded-2xl flex justify-between items-center text-white relative overflow-hidden">
                    <div class="absolute -left-4 -bottom-4 w-32 h-32 bg-orange-600/10 rounded-full"></div>
                    <div>
                        <p class="uppercase text-[10px] font-black tracking-[0.3em] opacity-60 italic">Total de Capital Retido</p>
                        <p class="text-xs italic opacity-80">Valores pendentes de pagamento para agendamentos já realizados.</p>
                    </div>
                    <div class="text-4xl font-black italic text-orange-500 z-10">
                        R$ {{ number_format($totalGlobalDividas, 2, ',', '.') }}
                    </div>
                </div>
            </div>
