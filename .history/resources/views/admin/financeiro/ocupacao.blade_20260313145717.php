<x-app-layout>
    <style>
        @media print {
            ...
            /* 2. Configurações da Folha - Ajuste de Margem Superior */
            @page {
                margin: 2cm 1cm 1.5cm 1cm;
                /* Aumentamos para 2cm no topo */
                size: A4 portrait;
            }
            ...
            /* 3. Ajuste do contêiner principal para não "subir" demais */
            .py-8 {
                padding-top: 1cm !important;
                /* Força um espaço no topo do conteúdo */
            }

            /* 4. Corrige o identificador do dia (aquele que cortou o '13') */
            .sticky {
            ...
            /* 5. Grid de 2 colunas organizado */
            .grid {
            ...
            /* 6. Cards sem quebras e com bordas visíveis */
