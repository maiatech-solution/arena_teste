  ...
  <style>
    @media print {
        ...
        body {
            ...
            margin: 0 !important;
            padding: 0 !important;
            overflow: visible !important; /* Evita que o navegador crie scroll infinito */
        }

        /* 3. Ajuste de Estrutura: Remove margens que causam páginas extras */
        ...
        /* 4. Controle de Quebra: O dia pode sangrar para a folha 2 se houver muitos jogos */
        ...
        /* 5. Grid de 3 Colunas: Máximo aproveitamento da largura */
        .grid {
        ...
        /* 6. Cards: Compactos para caber mais por folha */
        #reportContent div.bg-white {
            page-break-inside: avoid !important;
            break-inside: avoid !important;
            border: 1px solid #e5e7eb !important;
            padding: 10px !important;
            margin-bottom: 5px !important; /* Espaço entre as fileiras */
        }

        /* 7. GARANTE QUE NÃO HAJA PÁGINA EM BRANCO NO FIM */
        #reportContent {
            margin-bottom: 0 !important;
            padding-bottom: 0 !important;
        }
