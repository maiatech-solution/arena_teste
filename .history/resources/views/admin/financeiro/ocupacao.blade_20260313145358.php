<x-app-layout>
  <style>
    @media print {
        /* 1. Esconde a navegação do sistema, header e filtros */
        nav, 
        header, 
        aside, 
        footer,
        ...
        /* 2. Força o fundo branco e remove margens do navegador */
        body {
        ...
        /* 3. Faz o conteúdo ocupar 100% da largura da folha */
        .max-w-7xl {
        ...
        /* 4. EVITA O CORTE: Transforma o grid em lista vertical */
        .grid {
            display: block !important;
        }

        /* 5. Ajusta cada card de jogo para não quebrar no meio da folha */
        ...
        /* 6. Mantém as cores dos badges (Verde de Pago / Vermelho de Falta) */
        * {
            -webkit-print-color-adjust: exact !important;
            print-color-adjust: exact !important;
        }

        /* 7. Ajusta os títulos dos dias (Timeline) */
        .sticky {
            position: relative !important;
