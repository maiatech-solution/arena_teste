<x-app-layout>
  <style>
    @media print {
        ...
        /* 2. Reset de Estrutura */
        body { background-color: white !important; }
        .py-8 { padding-top: 0 !important; }
        .max-w-7xl { max-width: 100% !important; width: 100% !important; margin: 0 !important; }

        /* 3. O SEGREDO: Impede que o título do dia "expulse" os cards para a próxima página */
        .relative.break-inside-avoid {
            page-break-inside: auto !important; /* Permite que o conteúdo do dia sangre para a próxima folha se necessário */
            break-inside: auto !important;
        }

        .sticky {
            position: relative !important;
            page-break-after: avoid !important; /* ORDEM: Não quebre a página depois de mim! */
            break-after: avoid !important;
            margin-bottom: 15px !important;
            display: flex !important;
        }

        /* 4. Ajuste do Grid para Paisagem */
        .grid {
        ...
        /* 5. Estilo dos Cards Individualmente */
        #reportContent div.bg-white {
            page-break-inside: avoid !important; /* O card em si não quebra, mas o grid pode */
