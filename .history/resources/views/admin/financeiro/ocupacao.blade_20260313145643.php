    ...
    <style>
        @media print {
            @page {
                size: A4 landscape;
                margin: 0.8cm;
                /* Reduzi um pouco a margem para ganhar espaço */
            }

            /* ... manter as regras anteriores de display none ... */

            /* 1. Comprime o espaço entre as linhas do Grid */
            .grid {
                display: grid !important;
                grid-template-columns: repeat(3, 1fr) !important;
                gap: 8px !important;
                /* Diminuído de 15px para 8px */
            }

            /* 2. Diminui levemente o tamanho dos cards para caberem 15 na mesma folha */
            #reportContent div.bg-white {
                padding: 8px !important;
                /* Compacta o conteúdo interno */
                margin-bottom: 0 !important;
                border-radius: 10px !important;
            }

            /* 3. Reduz o tamanho da fonte apenas na impressão */
            .text-sm {
            ...
            /* 4. Remove espaços desnecessários da timeline */
            .sticky {
