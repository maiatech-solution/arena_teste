            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-indigo-600 to-indigo-700 p-6 rounded-[2rem] shadow-lg text-white relative overflow-hidden group">
                    ...
                    <p class="text-xs opacity-80 uppercase font-black tracking-widest">
                        {{ request('arena_id') ? 'Receita da Unidade' : 'Receita Bruta Total' }}
                    </p>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-3xl font-black text-gray-800 dark:text-white mt-1">
                        {{ $totalReservasMes }}
                        <span class="text-sm font-normal text-gray-400 uppercase">Reservas</span>
                    </p>
                    @if(!request('arena_id') && $totalReservasMes > 0)
                    <p class="text-[10px] text-indigo-500 font-bold uppercase mt-2 italic">Soma de todas as arenas</p>
                    @endif
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-[2rem] shadow-sm border border-red-50 dark:border-red-900/10">
                    <p class="text-xs text-gray-400 uppercase font-black tracking-widest">Prejuízo (No-Show)</p>
                    <p class="text-3xl font-black text-red-500 mt-1">
                        {{ $canceladasMes }}
                        <span class="text-sm font-normal text-gray-400 uppercase">Faltas</span>
                    </p>
                    <p class="text-[10px] text-gray-400 font-bold uppercase mt-2">Impacto na reputação da unidade</p>
                </div>
            </div>
