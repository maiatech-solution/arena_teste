        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-black text-xl text-gray-800 dark:text-gray-200 uppercase tracking-tighter">
                    ...
                    🏆 Ranking: {{ request('arena_id') ? (\App\Models\Arena::find(request('arena_id'))?->name ?? 'Unidade não encontrada') : 'Todas as Unidades' }}
                </h2>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 print:hidden">
                <form method="GET" action="{{ route('admin.financeiro.relatorio_ranking') }}" id="filterForm" class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">

                    {{-- Arena --}}
                    <div class="md:col-span-4">
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-1 ml-1">🏟️ Unidade</label>
                        <select name="arena_id" onchange="this.form.submit()" class="w-full rounded-xl border-gray-300 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 font-bold text-sm">
                    ...
                    {{-- Mês --}}
                    <div class="md:col-span-4">
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-1 ml-1">📅 Mês Referência</label>
                        <select name="mes" onchange="this.form.submit()" class="w-full rounded-xl border-gray-300 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 font-bold text-sm">
                    ...
                    <div class="md:col-span-4">
                        ...
                        <select name="ano" onchange="this.form.submit()" class="w-full rounded-xl border-gray-300 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 font-bold text-sm">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden italic">
                <div class="p-8 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 font-medium italic">
                            ...
                            <span class="text-indigo-500 font-bold">
                                ...
                                @else
                                    {{ \Carbon\Carbon::create()->month(request('mes', now()->month))->locale('pt_BR')->monthName }} de {{ request('ano', now()->year) }}
                                @endif
                            </span>
                    ...
                    <div class="hidden md:block">
                        <span class="text-[10px] bg-indigo-100 text-indigo-600 px-3 py-1 rounded-full font-black uppercase">Atualizado em Tempo Real</span>
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors group">
                                ...
                                <td class="px-6 py-5 text-center font-black text-gray-600 dark:text-gray-400 text-sm">
                                    <div class="inline-block px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full italic">
                                        {{ $cliente->total_reservas }} <span class="text-[9px] text-gray-400 ml-1 uppercase">Jogos</span>
                                    </div>
                                </td>
                                <td class="px-8 py-5 text-right font-mono font-black text-emerald-600 dark:text-emerald-400 text-lg italic">
