<x-app-layout>
    <style>
        @media print {
            ...
            /* 1. Reset de Página e Visibilidade */
            @page {
                size: A4 landscape;
                margin: 1cm;
            }
            ...
            /* 2. FORÇAR EXIBIÇÃO: Garante que o navegador não esconda o que transborda a primeira página */
            html,
            body {
            ...
            /* 3. Ajuste do Contêiner Principal */
            .py-8,
            .max-w-7xl {
                padding: 0 !important;
                margin: 0 !important;
            ...
            .relative.break-inside-avoid {
                ...
                /* Permite que o dia quebre entre páginas */
                break-inside: auto !important;
                margin-bottom: 2.5rem !important;
                clear: both !important;
                /* Garante que um dia não "atropele" o outro lateralmente */
            }
            ...
            /* 6. Grid Dinâmico (Sem travas de altura) */
            .grid {
            ...
            /* 8. Remove a linha lateral que pode causar falsos cortes */
            .border-l-2 {
