<x-app-layout>
    <style>
        @media print {
            ...
            /* 1. Configuração de Página - Paisagem Flexível */
            @page {
                size: A4 landscape;
                margin: 1cm;
            }
            ...
            /* 3. Estrutura Dinâmica: Remove restrições de altura e quebras forçadas */
            .py-8 {
                padding: 0 !important;
            }
            ...
            /* Contêiner do Dia: Agora ele flui livremente entre as páginas */
            ...
            /* 4. Título do Dia: Fica onde estiver, mas não deixa o conteúdo sozinho */
            .sticky {
            ...
            /* 5. GRID DINÂMICO: O navegador decide as colunas com base no espaço */
            .grid {
                display: grid !important;
                /* Tenta manter cards de aprox. 250px. Se couber 3, 4 ou 5, ele ajusta */
            ...
            /* 6. OS CARDS: Única coisa que não pode quebrar ao meio */
            ...
            /* 7. Remove decorações que travam o layout */
            .border-l-2 {
                border: none !important;
                margin: 0 !important;
                padding: 0 !important;
            ...
            /* Força cores de badges e backgrounds */
            * {
