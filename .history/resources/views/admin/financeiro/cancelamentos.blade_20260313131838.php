                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm divide-y dark:divide-gray-700 font-bold">
                                ...
                                <tr class="hover:bg-red-50/30 dark:hover:bg-red-900/10 transition duration-150">
                                    ...
                                    <td class="p-4">
                                        ...
                                        <div
                                            ...
                                            {{-- 🎯 LABEL DISCRETO DE ESTORNO/MULTA VINCULADA --}}
                                            @php
                                                // Procura na coleção de multas se existe algum registro financeiro vinculado a este ID (#5368, etc)
                                                $movimentacaoVinculada = $multasAvulsas
                                                    ->filter(function ($m) use ($c) {
                                            ...
                                            @if ($movimentacaoVinculada)
                                                @if ($movimentacaoVinculada->amount < 0)
                                                    <span
                                                        ...
                                                        title="O sinal pago foi devolvido ao cliente">
                                                ...
                                                @else
                                                    <span
                                                        ...
                                                        title="A multa ficou retida no caixa">
                                                        <svg class="w-2 h-2 mr-1" fill="currentColor"
                                                            viewBox="0 0 20 20">
                            ...
                            {{-- 2. LISTAGEM DE MULTAS AVULSAS (Apenas as que NÃO possuem #ID na descrição) --}}
                            {{-- Isso garante que testes ou multas manuais do caixa não se percam --}}
                            @foreach ($multasAvulsas as $m)
                                @php
                                    // Se a descrição NÃO contém um ID de reserva (ex: #5368), mostramos como linha avulsa
                                    $possuiVinculo = false;
                                    foreach ($cancelamentos as $can) {
                                        if (str_contains($m->description, "#{$can->id}")) {
                                            $possuiVinculo = true;
                                            break;
                                        }
                                    }
                                ...
                                @if (!$possuiVinculo)
                                    <tr
                                        ...
                                        <td class="p-4">
                                            ...
                                            <div class="text-[10px] text-gray-400 font-mono italic uppercase">
                                                Lançamento Avulso Caixa</div>
                                        </td>
                                        <td class="p-4 text-center">
                                            <span
