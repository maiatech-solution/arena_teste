<x-app-layout>
    <style>
        @media print {
            ...
            /* 1. Configuração da Página: Força Modo Paisagem */
            @page {
                size: A4 landscape;
                margin: 1cm;
            }
            ...
            /* 3. Ajuste do Conteúdo para não subir demais */
            .py-8 {
                padding-top: 0.5cm !important;
            }

            /* 4. Grid em Paisagem: 3 ou 4 colunas aproveitam melhor o papel largo */
            .grid {
                display: grid !important;
                grid-template-columns: repeat(3, 1fr) !important;
                /* 3 cards por linha fica ótimo em paisagem */
                gap: 15px !important;
            }
            ...
            /* 7. Ajuste de Largura Total */
            .max-w-7xl {
                max-width: 100% !important;
                width: 100% !important;
            }

            /* 8. Forçar cores de badges */
            * {
