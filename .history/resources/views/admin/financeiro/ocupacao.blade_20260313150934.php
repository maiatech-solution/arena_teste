<x-app-layout>
  <style>
    @media print {
        /* 1. Reset de Estrutura do Jetstream/Tailwind */
        /* Isso remove as travas de altura que cortam a página */
        html, body {
        ...
        /* 2. Força o conteúdo a ignorar o limite do Layout */
        main, .py-12, .py-8, .max-w-7xl, .sm\:px-6, .lg\:px-8 {
        ...
        nav, header, aside, footer, .print\:hidden, #ocupacaoFilterForm, .bg-indigo-50 {
        ...
        /* Título da Data - Para não ser cortado */
        .sticky {
        ...
        /* Remove a linha lateral que causa erros de página */
        .border-l-2 { border: none !important; margin: 0 !important; padding: 0 !important; }
