<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-8 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                    <h3 class="text-xs font-black text-indigo-600 uppercase tracking-[0.2em]">Top 15 Clientes da Arena
                    </h3>
                    {{-- Ajuste no texto para refletir a lógica de "Jogos Pagos" --}}
                    <p class="text-sm text-gray-400 font-medium italic">Baseado no histórico de partidas efetivamente
                        pagas e realizadas.</p>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr
                                ...
                                <th class="px-6 py-5 text-center whitespace-nowrap">Jogos Pagos</th>
                                    ...
                                    <td
                                        ...
                                        <div class="inline-block px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full">
                                            {{ $cliente->total_reservas }} <span
                                                class="text-[9px] text-gray-400 ml-1 italic">Vezes</span>
                                        </div>
                                    </td>
                                    <td
                                        class="px-8 py-5 text-right font-mono font-black text-emerald-600 dark:text-emerald-400 text-lg">
