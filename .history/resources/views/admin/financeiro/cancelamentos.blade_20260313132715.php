                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm divide-y dark:divide-gray-700 font-bold">
                            ...
                            @foreach ($cancelamentos as $c)
                                @php
                                    // 🎯 Lógica de Cálculo Líquido para a Linha
                                    $movimentacaoVinculada = $multasAvulsas->filter(function ($m) use ($c) {
                                        return str_contains($m->description, "#{$c->id}");
                                    });

                                    $valorRetido = $movimentacaoVinculada->sum('amount');

                                    // O prejuízo da linha só diminui se o valor for positivo (dinheiro que ficou no bolso)
                                    // Se for negativo (estorno), o prejuízo permanece o valor cheio da reserva
                                    $prejuizoLinha = $c->price - max(0, $valorRetido);
                                @endphp
                                ...
                                <tr class="hover:bg-red-50/30 dark:hover:bg-red-900/10 transition duration-150">
                                        ...
                                        <div
                                            ...
                                            @elseif($valorRetido > 0)
                                                <span
                                                    ...
                                                    Multa Retida (R$ {{ number_format($valorRetido, 2, ',', '.') }})
                                                </span>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    {{-- ✅ Valor Líquido: Aqui mostrará 80 para Adalberton e 100 para André --}}
