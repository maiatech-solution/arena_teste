        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase italic">Cliente / Descrição</th>
                        ...
                        <td class="px-6 py-4 text-center">
                            @php
                                $tipoMapeado = [
                                    ...
                                    'sangria' => ['label' => 'Sangria', 'class' => 'bg-red-50 text-red-600 border border-red-100'],
                                    'reforco' => ['label' => 'Reforço', 'class' => 'bg-emerald-50 text-emerald-600 border border-emerald-100'],
                                ];
