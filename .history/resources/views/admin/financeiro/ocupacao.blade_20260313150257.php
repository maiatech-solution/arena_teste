<x-app-layout>
  <style>
    @media print {
        /* 1. Configuração da Folha e Orientação */
        @page {
            size: A4 landscape;
            margin: 1cm;
        }
        ...
        /* 3. A MÁGICA: Cada bloco de data força uma nova página */
        #reportContent > div {
        ...
        /* Remove a quebra automática na última página para não sair folha em branco */
        #reportContent > div:last-child {
            page-break-after: auto !important;
            break-after: auto !important;
        }

        /* 4. Título do Dia (Identificador) */
        .sticky {
        ...
        /* 5. Grid: 4 colunas em Paisagem para caber o dia 13 inteiro */
        .grid {
        ...
        /* 7. Remove decorações que causam erros de alinhamento */
        .border-l-2 { border: none !important; margin-left: 0 !important; padding-left: 0 !important; }
