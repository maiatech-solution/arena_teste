...
{
    /**
     * 🛑 NOVO: Construtor para garantir que apenas gestores usem o Controller.
     * Isto reforça a proteção contra falhas de sessão/autorização em AJAX.
     */
    public function __construct()
    {
        // Aplica o middleware 'auth' e 'gestor' a todas as funções
