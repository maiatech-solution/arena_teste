...
class ReservaController extends Controller
{
    ...
    public function confirmar(Request $request, Reserva $reserva)
    {
        ...
        // 🚨 NOVO LOG DE DEBUG
        Log::debug("isRecurrent Recebido: " . ($isRecurrent ? 'TRUE' : 'FALSE') . ", Valor RAW: " . ($request->input('is_recurrent') ?? 'null'));
        ...
        try {
            ...
            if ($isRecurrent) { // SÓ EXECUTA SE O CHECKBOX ESTIVER MARCADO
                ...
                Log::debug("Iniciando a lógica de criação de série recorrente.");
