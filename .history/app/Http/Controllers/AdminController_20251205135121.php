...
class AdminController extends Controller
{
    ...
    public function indexFinancialDashboard(Request $request) // 🛑 RENOMEADO: De indexPagamentos para indexFinancialDashboard
    {
        ...
        Log::info("DEBUG FINANCEIRO: KPIs FINAIS para View - Data: {$date} | Recebido HOJE (\$totalReceived): R$ " . number_format($totalReceived, 2, ',', '.') . " | Saldo GLOBAL (\$totalGlobalBalance): R$ " . number_format($totalBalance, 2, ',', '.'));
