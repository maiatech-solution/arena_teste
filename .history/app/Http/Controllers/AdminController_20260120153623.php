...
class AdminController extends Controller
{
    ...
    /**
     * 🔄 Reativação Inteligente de Horário em Manutenção via Backup
     * Com mensagens personalizadas para Mensalistas e Pontuais.
     */
        ...
        try {
            ...
            if ($decisao === 'restore_client') {
                if (preg_match('/###BACKUP###(.*?)###END###/s', $reserva->notes, $matches)) {
                    ...
                    if ($reserva->is_recurrent && $valorOriginal > 0) {
                    ...
                    // CENÁRIO B: PONTUAL OU RECORRENTE COM ESTORNO (Pagamento integral hoje)
                    else {
