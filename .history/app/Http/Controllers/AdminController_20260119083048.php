...
class AdminController extends Controller
{
    ...
    public function reativarManutencao($id)
    {
        try {
            ...
            // Deletamos o slot de manutenção para que o ReservaController->recreateFixedSlot
            // ou a própria limpeza do sistema libere o horário como VERDE/FREE.
            $reserva->delete();

            return redirect()->back()->with('success', 'Manutenção finalizada. O horário foi liberado na grade!');
        } catch (\Exception $e) {
