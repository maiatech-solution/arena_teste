...
class FinanceiroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Somamos reservas com status No-Show + Multas registradas diretamente no caixa
        ...
        // Total de faltas que impactaram o sistema
    ...
    {
        $arenaId = $request->get('arena_id');
        // Garante que sejam inteiros para o Carbon não reclamar na View
        ...
        $query = Reserva::whereIn('status', [
            ...
            ->whereYear('date', $ano)
            ->whereMonth('date', $mes) // Removi o 'all' para simplificar, já que a view envia 1-12
            ->when($arenaId, fn($q) => $q->where('arena_id', $arenaId))
            ->with(['user', 'arena']);
