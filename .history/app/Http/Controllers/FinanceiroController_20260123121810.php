...
class FinanceiroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 🚫 3. Faltas Filtradas (No-Show) - CORREÇÃO DE PRECISÃO
        // Primeiro: Contamos as reservas marcadas como No-Show no banco
        ...
        // Segundo: Contamos multas avulsas no financeiro.
        // Filtramos amount > 0 para não contar estornos/logs e whereNull para não duplicar com as reservas acima.
        ...
        // 💸 4. Cálculo de Dívidas Pendentes (ACUMULADO DO MÊS)
        // Busca reservas concluídas ou faltas que ainda não foram totalmente pagas
