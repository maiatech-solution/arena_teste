    ...
    public function finalizarPagamento(Request $request, Reserva $reserva)
    {
        ...
        try {
            ...
            if ($request->boolean('apply_to_series') && $reserva->is_recurrent) {
                ...
                // A data de corte é a data da reserva PAGA (3934).
                $reservaDate = Carbon::parse($reserva->date)->toDateString();

                // ✅ QUERY CORRIGIDA: Inclui o status PARTIAL para pegar reservas já iniciadas mas não concluídas.
                $updatedCount = Reserva::where('recurrent_series_id', $masterId)
                       ...
                       // 🛑 INCLUÍDO STATUS_PARTIAL para atingir reservas futuras com sinal pago, mas com preço desatualizado.
