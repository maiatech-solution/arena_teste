        ...
        return DB::transaction(function () use ($request, $id) {
            try {
                ...
                if ($valorPagoOriginal > 0) {
                    // Tenta localizar a próxima reserva (Apenas para Mensalistas/Recorrentes)
                    $proximaReserva = null;
                    if ($reserva->recurrent_series_id) {
                    ...
                    // A) Se escolheu Transferir e existe uma próxima reserva
                    ...
                    // B) Se for PONTUAL ou se escolheu ESTORNO ou se não houver próxima reserva
                    else {
