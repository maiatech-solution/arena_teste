...
class ReservaController extends Controller
{
    ...
    public function finalizarPagamento(Request $request, Reserva $reserva)
    {
        ...
        try {
            ...
            if ($request->boolean('apply_to_series') && !empty($reserva->series_id)) {
                ...
                // Query para encontrar reservas futuras ativas nesta série, começando do dia seguinte à reserva atual.
                $updatedCount = Reserva::where('recurrent_series_id', $reserva->series_id)
                ...
                Log::info("Preço de série recorrente (ID {$reserva->series_id}) atualizado para R$ {$newPriceForSeries} em {$updatedCount} reservas futuras. Por Gestor ID: " . Auth::id());
            }
