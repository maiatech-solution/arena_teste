...
class FinanceiroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 🚫 3. Faltas Filtradas (No-Show) - COM TRAVA DE DUPLICIDADE
        ...
        // Contamos multas no financeiro apenas se não tiverem reserva_id (evita duplicar a mesma falta)
        ...
        // 💸 4. Cálculo de Dívidas Pendentes (ADICIONADO PARA O NOVO CARD)
        // Buscamos o valor que falta pagar de reservas concluídas (completed) ou no_show que restam saldo
        ...
        return view('admin.financeiro.index', compact(
            ...
            'totalReservasMes',
            'canceladasMes',
            'totalGlobalDividas', // Enviando para a View
            'arenas',
            'dataFiltro'
        ));
    }
