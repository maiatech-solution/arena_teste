...
class BarCompanyController extends Controller
{
    ...
    {
        $company = \App\Models\Arena::findOrFail(auth()->user()->arena_id);

        // O Laravel procura: resources/views/ + bar/unidade/edit.blade.php
        return view('bar.unidade.edit', compact('company'));
    }
    ...
    {
        $company = Arena::findOrFail(auth()->user()->arena_id);
