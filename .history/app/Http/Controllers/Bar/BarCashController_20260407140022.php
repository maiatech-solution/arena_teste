...
class BarCashController extends Controller
{
    ...
    public function close(Request $request)
    {
        ...
        return \Illuminate\Support\Facades\DB::transaction(function () use ($request, $autorizadorNome) {
            ...
            // No BarCashController.php, método close:
            $company = \App\Models\Bar\BarCompany::first(); // Busca os dados da arena

            return redirect()->route('bar.cash.index')->with([
                'success' => $msg,
                'arena_nome_print' => $company->nome_fantasia ?? 'MAIATECH ARENA', // Pega o nome real
