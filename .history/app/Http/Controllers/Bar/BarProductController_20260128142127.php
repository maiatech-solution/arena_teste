...
class BarProductController extends Controller
{
    ...
    {
        // Inverte o status: se for true (1) vira false (0), e vice-versa
        $product->update([
            'is_active' => !$product->is_active
        ]);

        // Prepara a mensagem de sucesso de acordo com o novo estado
        $mensagem = $product->is_active
            ? "Produto '{$product->name}' reativado com sucesso!"
