...
class BarProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 🚀 Filtro por Status (Ajustado para respeitar manage_stock)
        if ($filterStatus === 'active') {
            ...
            $query->where('is_active', true)
                ->where('manage_stock', true) // 🔥 Só mostra no alerta se o controle estiver ligado
        ...
        // ⚠️ Produtos críticos agora ignoram quem não tem controle ativo
