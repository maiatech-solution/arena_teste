    ...
    public function getDetails($tipo, $id)
    {
        try {
            ...
            if ($tipoLower === 'mesa' || $tipoLower === 'mesas') {
                ...
                // 🔍 Como bar_orders não tem a coluna, buscamos o pagamento na bar_sales
                // que foi gerada a partir desta ordem
            ...
            return response()->json([
                ...
                // 💳 Exibe o método encontrado ou 'PAGO' caso não localize o vínculo
