...
class ReservaController extends Controller
{
    ...
    {
        // 🚨 LOG DE DEBUG: Despeja todo o request para ver se 'is_recurrent' está presente
        Log::info("DEBUG - Request completo na confirmação: " . json_encode($request->all()));
        ...
        // 🚨 CORREÇÃO DE DEBUG: Usando Log::info para garantir que o valor seja visto
        Log::info("DEBUG - isRecurrent (bool): " . ($isRecurrent ? 'TRUE' : 'FALSE') . ", Valor RAW: " . ($request->input('is_recurrent') ?? 'null'));
        ...
        try {
            ...
            // 🚨 LOG CUSTOMIZADO DO USUÁRIO ADICIONADO AQUI
            // Manteve o log original do usuário para referência da ação de INFO
            ...
            if ($isRecurrent) { // SÓ EXECUTA SE O CHECKBOX ESTIVER MARCADO
                ...
                Log::info("DEBUG - Iniciando a lógica de criação de série recorrente.");
