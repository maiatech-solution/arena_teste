        ...
        try {
            ...
            if ($request->boolean('apply_to_series') && $reserva->is_recurrent) {
                ...
                $updatedCount = Reserva::where(function ($query) use ($masterId) {
                   ...
                   // ✅ NOVO: Exclui explicitamente o ID da reserva que acabou de ser paga para evitar redundância,
                   // mas mantém a robustez da query de data/hora para pegar o próximo slot (ID 3907, na próxima semana).
                   ->where('id', '!=', $reserva->id)
