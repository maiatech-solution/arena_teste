...

{
    ...
    public function closeCash(Request $request)
    {
        ...
        try {
            ...
            // Armazenamos o objeto criado para pegar o ID depois
            ...
            // 🚀 GERAÇÃO DA URL DE IMPRESSÃO
            // Ajustei para passar os parâmetros necessários para o relatório de fechamento
            $printUrl = route('admin.financeiro.relatorio_caixa', [
                'date'     => $date,
                'arena_id' => $arenaId,
                'print'    => 1 // Flag para o JS da view de relatório disparar o print()
            ]);
