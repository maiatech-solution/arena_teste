...

{
    ...
    public function closeCash(Request $request)
    {
        ...
        try {
            ...
            // Mantenha os nomes das chaves iguais ao que o JS pede: gaveta e banco
            ...
            // 🚀 O SEGREDO ESTÁ AQUI: Chaves idênticas ao JavaScript
            return response()->json([
                'success' => true,
                'resumo' => [
                    ...
                    'gaveta'    => (float)$totalGaveta, // JS espera 'gaveta'
                    'banco'     => (float)$totalBanco,  // JS espera 'banco'
                    'credito'   => 0,
