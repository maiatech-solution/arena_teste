...
class AdminController extends Controller
{
    ...
    /**
     * Método unificado para cancelamento de série (Dashboard + Lista de Usuários)
     */
    public function cancelClientSeries(Request $request, $reservaId)
    {
        // Apenas redirecionamos para a função que já funciona e tem toda a lógica
        return $this->cancelarSerieRecorrente($request, $reservaId);
    }
