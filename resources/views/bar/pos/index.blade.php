        ...
        <script>
            ...
            function validateCheckout() {
                ...
                if (cart.length > 0 && paymentMethod) {
                    ...
                    // 2. Garante a troca de cores e cursor (Remove o velho e força o novo)
                    ...
                    // 3. Feedback visual de hover
                    finishBtn.classList.add('hover:bg-green-500', 'active:scale-95', 'transition-all');
                } else {
                    // Caso o usuário remova itens ou mude algo, o botão volta a "travar"
                    finishBtn.disabled = true;
