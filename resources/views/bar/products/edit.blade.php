        ...
        <div class="bg-gray-900 rounded-3xl border border-gray-800 p-8 shadow-2xl">
            ...
            <form action="{{ route('bar.products.update', ['product' => $product->id]) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-orange-500 uppercase mb-2 tracking-widest">Unidade de
                            Compra</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-orange-500 uppercase mb-2 tracking-widest">Qtd no
                            Fardo/Caixa</label>
                        <input type="number" name="content_quantity"
                            value="{{ old('content_quantity', $product->content_quantity ?? 1) }}" min="1"
                            required
                            class="w-full bg-gray-950 border-gray-800 rounded-xl text-white focus:border-orange-500 focus:ring-orange-500 p-3">
                        <p class="text-[9px] text-gray-500 mt-1 uppercase font-bold italic tracking-tighter">* Valor
                            usado para converter entradas de fardos.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock_quantity"
                            ...
                            class="w-full bg-gray-800 border-gray-700 rounded-xl text-gray-500 p-3 cursor-not-allowed font-bold"
                            title="O estoque só pode ser alterado via Entrada ou Registro de Perda">

                        <p class="text-[9px] text-gray-600 mt-2 uppercase font-bold italic tracking-tighter">
                            ⚠️ Bloqueado: Use "Entrada" ou "Perda" para movimentar o saldo.
                        </p>
                    </div>
