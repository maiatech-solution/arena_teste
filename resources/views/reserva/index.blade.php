    ...
    <head>
        ...
        <style>
            ...
            /* 🛑 ESTILO OBSOLETO/REMOVIDO: A remoção visual agora é feita de forma confiável pelo JS no hook eventDidMount. */
            /* Mantemos o bloco vazio apenas para referência. */
    ...
    <div id="booking-modal" class="fixed inset-0 bg-gray-900 bg-opacity-80 backdrop-blur-sm hidden items-center justify-center z-50 p-4">
        <div id="modal-content" class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-100 border-t-8
            ...
            <form id="booking-form" method="POST" action="{{ route('reserva.store') }}">
                ...
                {{-- CRÍTICO: Campo oculto que contém o ID do slot fixo. (O debug visual foi removido) --}}
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateDayMarkers(calendar) {
                ...
                dayCells.forEach(dayEl => {
                    ...
                    // 3. Contêiner onde o marcador será injetado
                    ...
                    if (availableSlots > 0) {
                        ...
                        // Não Disponível (Ocupado ou Fechado)
                    ...
                    // 5. Remoção do marcador antigo e Injeção do novo
            ...
            let calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventSources: [
                    ...
                    // 🛑 CORRIGIDO: Permite que o FullCalendar carregue e renderize os eventos verdes em todas as views
                    {
                        ...
                        display: 'block' // Valor padrão (removendo a restrição anterior)
                    }
                ],
                ...
                views: {
                    ...
                    timeGridDay: {
                        buttonText: 'Dia',
                        // Garante que a agenda começa em um horário razoável
                ...
                // ✅ HOOK CRÍTICO: Garante que o marcador seja inserido APÓS o carregamento de todos os eventos
                eventsSet: function(info) {
                    // Chamado sempre que o conjunto de eventos muda (incluindo AJAX e mudança de mês)
                    updateDayMarkers(calendar);
                },

                // 🛑 HOOK CRÍTICO: Esconde os eventos verdes APENAS na view de Mês.
                eventDidMount: function(info) {
                    if (info.view.type === 'dayGridMonth' && info.event.classNames.includes('fc-event-available')) {
                        // Oculta o elemento do evento (slot verde) no mês.
                ...
                eventClick: function(info) {
                    ...
                    if (isAvailable) {
                        ...
                        // Verificação de dados mínimos para evitar quebras se a API retornar dados incompletos
            ...
            if (oldDate && oldStart) {
                ...
                // 🛑 NOVO: Em caso de erro, reabre no modo Dia na data correta para visualização
